...
80105283:	e8 18 1c 00 00       	call   80106ea0 <shm_close>
}
80105288:	c9                   	leave  
80105289:	c3                   	ret    
...
80106d03:	8b 00                	mov    (%eax),%eax
  ...
  //Get locks
  initlock(&(shm_table.lock), "SHM lock");
80106d05:	c7 44 24 04 34 79 10 	movl   $0x80107934,0x4(%esp)
80106d0c:	80 
80106d0d:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
...
80106d14:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
  ...
  //Get locks
  initlock(&(shm_table.lock), "SHM lock");
80106d1a:	e8 41 d3 ff ff       	call   80104060 <initlock>
...
int shm_open(int id, char **pointer) {
  ...
  //get the current process virtual memory
  uint va = PGROUNDUP(curproc->sz);
80106d1f:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  int i;
  char * new_page;
  ...
  initlock(&(shm_table.lock), "SHM lock");
  acquire(&(shm_table.lock));
80106d25:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106d2c:	e8 1f d4 ff ff       	call   80104150 <acquire>
80106d31:	b9 f4 54 11 80       	mov    $0x801154f4,%ecx
  //Look through the shm_table
  for (i = 0; i< 64; i++){
80106d36:	31 d2                	xor    %edx,%edx
80106d38:	eb 11                	jmp    80106d4b <shm_open+0x5b>
80106d3a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80106d40:	83 c2 01             	add    $0x1,%edx
80106d43:	83 c1 0c             	add    $0xc,%ecx
80106d46:	83 fa 40             	cmp    $0x40,%edx
80106d49:	74 6d                	je     80106db8 <shm_open+0xc8>
...
80106d4f:	8d 14 52             	lea    (%edx,%edx,2),%edx
80106d52:	c1 e2 02             	shl    $0x2,%edx
80106d55:	8b 82 f8 54 11 80    	mov    -0x7feeab08(%edx),%eax
80106d5b:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106d62:	00 
...
80106d7b:	89 55 e4             	mov    %edx,-0x1c(%ebp)
...
80106d8b:	0f 85 f5 00 00 00    	jne    80106e86 <shm_open+0x196>
...
80106d91:	8b 45 0c             	mov    0xc(%ebp),%eax
      ...
      //increment reference counter
      shm_table.shm_pages[i].refcnt++;
80106d94:	83 82 fc 54 11 80 01 	addl   $0x1,-0x7feeab04(%edx)
      //pass the new virtual address
      *pointer = (char *)va;
80106d9b:	89 30                	mov    %esi,(%eax)
      curproc->sz = va;
80106d9d:	89 37                	mov    %esi,(%edi)
      //release lock
      release(&(shm_table.lock));
80106d9f:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106da6:	e8 95 d4 ff ff       	call   80104240 <release>
      return id; //done
...
80106dad:	83 c4 2c             	add    $0x2c,%esp
80106db0:	5b                   	pop    %ebx
80106db1:	5e                   	pop    %esi
80106db2:	5f                   	pop    %edi
80106db3:	5d                   	pop    %ebp
...
80106db5:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  //Look through the shm_table
  for (i = 0; i< 64; i++){
80106db8:	b8 f4 54 11 80       	mov    $0x801154f4,%eax
80106dbd:	30 d2                	xor    %dl,%dl
...
80106dcb:	83 c0 0c             	add    $0xc,%eax
80106dce:	83 fa 40             	cmp    $0x40,%edx
80106dd1:	0f 84 a5 00 00 00    	je     80106e7c <shm_open+0x18c>
    //find the empty page entry
    if (!shm_table.shm_pages[i].id){
80106dd7:	8b 08                	mov    (%eax),%ecx
80106dd9:	85 c9                	test   %ecx,%ecx
80106ddb:	75 eb                	jne    80106dc8 <shm_open+0xd8>
80106ddd:	89 55 e0             	mov    %edx,-0x20(%ebp)
...
80106de5:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106dec:	00 
80106ded:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106df4:	00 
80106df5:	89 04 24             	mov    %eax,(%esp)
80106df8:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106dfb:	e8 90 d4 ff ff       	call   80104290 <memset>
      //assign the id to the current share mem page
      shm_table.shm_pages[i].id = id;
80106e00:	8b 55 e0             	mov    -0x20(%ebp),%edx
...
80106e03:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106e06:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106e0d:	00 
...
80106e15:	00 
      ...
      //assign the id to the current share mem page
      shm_table.shm_pages[i].id = id;
80106e16:	8d 14 52             	lea    (%edx,%edx,2),%edx
80106e19:	c1 e2 02             	shl    $0x2,%edx
      //mapping to the page table : {get current page , assign frame , size of the page size = virtual page size,
                                  // physical address, write flag}
      if(mappages(curproc->pgdir, (void *)va, PGSIZE, V2P(new_page), PTE_W|PTE_U))
80106e1c:	8d 81 00 00 00 80    	lea    -0x80000000(%ecx),%eax
      //allocate a new physical page
      new_page = kalloc();
      //set the page size
      memset(new_page, 0, PGSIZE);
      //assign the id to the current share mem page
      shm_table.shm_pages[i].id = id;
80106e22:	89 9a f4 54 11 80    	mov    %ebx,-0x7feeab0c(%edx)
      //mapping to the page table : {get current page , assign frame , size of the page size = virtual page size,
                                  // physical address, write flag}
      if(mappages(curproc->pgdir, (void *)va, PGSIZE, V2P(new_page), PTE_W|PTE_U))
80106e28:	89 44 24 0c          	mov    %eax,0xc(%esp)
80106e2c:	89 74 24 04          	mov    %esi,0x4(%esp)
80106e30:	8b 47 04             	mov    0x4(%edi),%eax
      //allocate a new physical page
      new_page = kalloc();
      //set the page size
      memset(new_page, 0, PGSIZE);
      //assign the id to the current share mem page
      shm_table.shm_pages[i].id = id;
80106e33:	89 55 dc             	mov    %edx,-0x24(%ebp)
      //mapping to the page table : {get current page , assign frame , size of the page size = virtual page size,
                                  // physical address, write flag}
      if(mappages(curproc->pgdir, (void *)va, PGSIZE, V2P(new_page), PTE_W|PTE_U))
80106e36:	89 4d e0             	mov    %ecx,-0x20(%ebp)
80106e39:	89 04 24             	mov    %eax,(%esp)
80106e3c:	e8 0f f7 ff ff       	call   80106550 <mappages>
80106e41:	85 c0                	test   %eax,%eax
80106e43:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106e46:	75 3e                	jne    80106e86 <shm_open+0x196>
        panic("Shared memory not mapped");
      //assign the new va to frame
      shm_table.shm_pages[i].frame = new_page;
80106e48:	8b 55 dc             	mov    -0x24(%ebp),%edx
      //start new reference counter
      shm_table.shm_pages[i].refcnt = 1;
      //pass back virtual address
      *pointer = (char *)va;
80106e4b:	8b 45 0c             	mov    0xc(%ebp),%eax
      //mapping to the page table : {get current page , assign frame , size of the page size = virtual page size,
                                  // physical address, write flag}
      if(mappages(curproc->pgdir, (void *)va, PGSIZE, V2P(new_page), PTE_W|PTE_U))
        panic("Shared memory not mapped");
      //assign the new va to frame
      shm_table.shm_pages[i].frame = new_page;
80106e4e:	8b 4d e0             	mov    -0x20(%ebp),%ecx
      //start new reference counter
      shm_table.shm_pages[i].refcnt = 1;
80106e51:	c7 82 fc 54 11 80 01 	movl   $0x1,-0x7feeab04(%edx)
80106e58:	00 00 00 
      //mapping to the page table : {get current page , assign frame , size of the page size = virtual page size,
                                  // physical address, write flag}
      if(mappages(curproc->pgdir, (void *)va, PGSIZE, V2P(new_page), PTE_W|PTE_U))
      ...
      //assign the new va to frame
      shm_table.shm_pages[i].frame = new_page;
80106e5b:	89 8a f8 54 11 80    	mov    %ecx,-0x7feeab08(%edx)
      //start new reference counter
      shm_table.shm_pages[i].refcnt = 1;
      //pass back virtual address
      *pointer = (char *)va;
80106e61:	89 30                	mov    %esi,(%eax)
      //assing virtual address to current sz
      curproc->sz = va;
80106e63:	89 37                	mov    %esi,(%edi)
      //release lock
      release(&(shm_table.lock));
80106e65:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106e6c:	e8 cf d3 ff ff       	call   80104240 <release>
      return 0;
...
80106e74:	83 c4 2c             	add    $0x2c,%esp
80106e77:	5b                   	pop    %ebx
80106e78:	5e                   	pop    %esi
80106e79:	5f                   	pop    %edi
80106e7a:	5d                   	pop    %ebp
...
80106e81:	e9 27 ff ff ff       	jmp    80106dad <shm_open+0xbd>
    //update share mem, map physical to virtual
    if (id == shm_table.shm_pages[i].id){
      //mapping to the page table : {get current page , virtual mem, size of the page size = virtual page size,
                                  // physical of the share mem table entry, write flag}
      if(mappages(curproc->pgdir, (void *)va, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W|PTE_U))
        panic("Shared memory not mapped");
80106e86:	c7 04 24 3d 79 10 80 	movl   $0x8010793d,(%esp)
...
80106ea4:	83 ec 14             	sub    $0x14,%esp
80106ea7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  //Get locks
  initlock(&(shm_table.lock), "SHM lock");
80106eaa:	c7 44 24 04 34 79 10 	movl   $0x80107934,0x4(%esp)
80106eb1:	80 
80106eb2:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106eb9:	e8 a2 d1 ff ff       	call   80104060 <initlock>
  acquire(&(shm_table.lock));
80106ebe:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106ec5:	e8 86 d2 ff ff       	call   80104150 <acquire>
80106eca:	b8 f4 54 11 80       	mov    $0x801154f4,%eax
80106ecf:	eb 11                	jmp    80106ee2 <shm_close+0x42>
80106ed1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80106ed8:	83 c0 0c             	add    $0xc,%eax
  int i;

  //loop through the table to find id
  for (i = 0; i < 64; ++i)
80106edb:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
80106ee0:	74 2e                	je     80106f10 <shm_close+0x70>
  {  
    if (shm_table.shm_pages[i].id == id)
80106ee2:	3b 18                	cmp    (%eax),%ebx
80106ee4:	75 f2                	jne    80106ed8 <shm_close+0x38>
    {
      //decrease reference count
      shm_table.shm_pages[i].refcnt--;
80106ee6:	8b 48 08             	mov    0x8(%eax),%ecx
80106ee9:	8d 51 ff             	lea    -0x1(%ecx),%edx
...
80106eec:	85 d2                	test   %edx,%edx
  ...
  {  
    if (shm_table.shm_pages[i].id == id)
    {
      //decrease reference count
      shm_table.shm_pages[i].refcnt--;
80106eee:	89 50 08             	mov    %edx,0x8(%eax)
      //if refcnt @ 0, free the shared mem entry
      if (shm_table.shm_pages[i].refcnt == 0)
80106ef1:	75 e5                	jne    80106ed8 <shm_close+0x38>
      {
        shm_table.shm_pages[i].id =0;
80106ef3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80106ef9:	83 c0 0c             	add    $0xc,%eax
        shm_table.shm_pages[i].frame =0;
80106efc:	c7 40 f8 00 00 00 00 	movl   $0x0,-0x8(%eax)
  initlock(&(shm_table.lock), "SHM lock");
  acquire(&(shm_table.lock));
  int i;
  ...
  //loop through the table to find id
  for (i = 0; i < 64; ++i)
80106f03:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
80106f08:	75 d8                	jne    80106ee2 <shm_close+0x42>
80106f0a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  release(&(shm_table.lock));
80106f10:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106f17:	e8 24 d3 ff ff       	call   80104240 <release>
  return 0; //added to remove compiler warning -- you should decide what to return
}
80106f1c:	83 c4 14             	add    $0x14,%esp
