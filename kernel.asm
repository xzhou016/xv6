...
80100519:	e8 f2 40 00 00       	call   80104610 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
8010052e:	e8 2d 40 00 00       	call   80104560 <memset>
...
801005a9:	0f b6 92 d0 70 10 80 	movzbl -0x7fef8f30(%edx),%edx
  }while((x /= base) != 0);
...
80100705:	e8 06 3e 00 00       	call   80104510 <release>
...
801007a8:	e8 43 3c 00 00       	call   801043f0 <acquire>
...
801007b8:	b8 28 00 00 00       	mov    $0x28,%eax
        s = "(null)";
801007bd:	bf b8 70 10 80       	mov    $0x801070b8,%edi
801007c2:	eb bc                	jmp    80100780 <cprintf+0x120>
    panic("null fmt");
801007c4:	83 ec 0c             	sub    $0xc,%esp
801007c7:	68 bf 70 10 80       	push   $0x801070bf
...
801007f3:	e8 f8 3b 00 00       	call   801043f0 <acquire>
  while((c = getc()) >= 0){
...
80100858:	e8 b3 3c 00 00       	call   80104510 <release>
  if(doprocdump) {
...
801008e6:	e8 45 37 00 00       	call   80104030 <wakeup>
...
80100967:	e9 b4 37 00 00       	jmp    80104120 <procdump>
        input.buf[input.e++ % INPUT_BUF] = c;
...
80100996:	68 c8 70 10 80       	push   $0x801070c8
...
80100a62:	75 d2                	jne    80100a36 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100a64:	e8 57 63 00 00       	call   80106dc0 <setupkvm>
...
80100af4:	e8 27 61 00 00       	call   80106c20 <allocuvm>
...
80100b2a:	e8 31 60 00 00       	call   80106b60 <loaduvm>
...
80100b49:	e8 f2 61 00 00       	call   80106d40 <freevm>
...
80100b85:	e8 96 60 00 00       	call   80106c20 <allocuvm>
...
80100b9c:	e8 9f 61 00 00       	call   80106d40 <freevm>
...
80100bb6:	68 e1 70 10 80       	push   $0x801070e1
...
80100be1:	e8 7a 62 00 00       	call   80106e60 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100c1d:	e8 5e 3b 00 00       	call   80104780 <strlen>
...
80100c30:	e8 4b 3b 00 00       	call   80104780 <strlen>
...
80100c41:	e8 6a 63 00 00       	call   80106fb0 <copyout>
...
80100ca5:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100cab:	e8 00 63 00 00       	call   80106fb0 <copyout>
...
80100cf0:	e8 4b 3a 00 00       	call   80104740 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100d1c:	e8 af 5c 00 00       	call   801069d0 <switchuvm>
  freevm(oldpgdir);
80100d21:	89 3c 24             	mov    %edi,(%esp)
80100d24:	e8 17 60 00 00       	call   80106d40 <freevm>
  return 0;
...
80100d46:	68 ed 70 10 80       	push   $0x801070ed
80100d4b:	68 c0 ff 10 80       	push   $0x8010ffc0
80100d50:	e8 9b 35 00 00       	call   801042f0 <initlock>
}
...
80100da1:	e8 6a 37 00 00       	call   80104510 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100dba:	e8 51 37 00 00       	call   80104510 <release>
}
...
80100dfc:	e8 0f 37 00 00       	call   80104510 <release>
  return f;
}
...
80100e0b:	68 f4 70 10 80       	push   $0x801070f4
...
80100e5b:	5d                   	pop    %ebp
    release(&ftable.lock);
80100e5c:	e9 af 36 00 00       	jmp    80104510 <release>
...
80100e85:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100e88:	e8 83 36 00 00       	call   80104510 <release>
  if(ff.type == FD_PIPE)
...
80100ee2:	68 fc 70 10 80       	push   $0x801070fc
...
80100fc2:	68 06 71 10 80       	push   $0x80107106
...
801010e0:	68 0f 71 10 80       	push   $0x8010710f
801010e5:	e8 86 f2 ff ff       	call   80100370 <panic>
  panic("filewrite");
801010ea:	83 ec 0c             	sub    $0xc,%esp
801010ed:	68 15 71 10 80       	push   $0x80107115
...
801011a4:	68 1f 71 10 80       	push   $0x8010711f
...
8010122a:	e8 c1 31 00 00       	call   801043f0 <acquire>
...
801012d4:	68 35 71 10 80       	push   $0x80107135
...
801013a5:	68 45 71 10 80       	push   $0x80107145
...
80101464:	68 58 71 10 80       	push   $0x80107158
...
8010147c:	68 6b 71 10 80       	push   $0x8010716b
...
80101493:	68 72 71 10 80       	push   $0x80107172
80101498:	53                   	push   %ebx
80101499:	81 c3 90 00 00 00    	add    $0x90,%ebx
8010149f:	e8 3c 2d 00 00       	call   801041e0 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801014e9:	68 d8 71 10 80       	push   $0x801071d8
...
801015b3:	68 78 71 10 80       	push   $0x80107178
...
8010164f:	e8 9c 2d 00 00       	call   801043f0 <acquire>
  ip->ref++;
...
80101692:	e8 89 2b 00 00       	call   80104220 <acquiresleep>
  if(ip->valid == 0){
...
8010172d:	68 90 71 10 80       	push   $0x80107190
80101732:	e8 39 ec ff ff       	call   80100370 <panic>
    panic("ilock");
80101737:	83 ec 0c             	sub    $0xc,%esp
8010173a:	68 8a 71 10 80       	push   $0x8010718a
...
80101763:	e8 58 2b 00 00       	call   801042c0 <holdingsleep>
...
8010177e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010177f:	e9 fc 2a 00 00       	jmp    80104280 <releasesleep>
    panic("iunlock");
80101784:	83 ec 0c             	sub    $0xc,%esp
80101787:	68 9f 71 10 80       	push   $0x8010719f
...
801017b0:	e8 6b 2a 00 00       	call   80104220 <acquiresleep>
...
801017ca:	e8 b1 2a 00 00       	call   80104280 <releasesleep>
  acquire(&icache.lock);
801017cf:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801017d6:	e8 15 2c 00 00       	call   801043f0 <acquire>
  ip->ref--;
...
80101800:	e8 eb 2b 00 00       	call   801043f0 <acquire>
    int r = ip->ref;
...
801019f5:	01 de                	add    %ebx,%esi
    memmove(dst, bp->data + off%BSIZE, m);
801019f7:	e8 14 2c 00 00       	call   80104610 <memmove>
    brelse(bp);
...
80101af3:	e8 18 2b 00 00       	call   80104610 <memmove>
    log_write(bp);
...
80101c2d:	68 b9 71 10 80       	push   $0x801071b9
80101c32:	e8 39 e7 ff ff       	call   80100370 <panic>
    panic("dirlookup not DIR");
80101c37:	83 ec 0c             	sub    $0xc,%esp
80101c3a:	68 a7 71 10 80       	push   $0x801071a7
...
80101c79:	e8 72 27 00 00       	call   801043f0 <acquire>
  ip->ref++;
...
80101e9b:	68 c8 71 10 80       	push   $0x801071c8
80101ea0:	e8 cb e4 ff ff       	call   80100370 <panic>
    panic("dirlink");
80101ea5:	83 ec 0c             	sub    $0xc,%esp
80101ea8:	68 c2 77 10 80       	push   $0x801077c2
...
80101fb0:	68 34 72 10 80       	push   $0x80107234
80101fb5:	e8 b6 e3 ff ff       	call   80100370 <panic>
    panic("idestart");
80101fba:	83 ec 0c             	sub    $0xc,%esp
80101fbd:	68 2b 72 10 80       	push   $0x8010722b
...
80101fd6:	68 46 72 10 80       	push   $0x80107246
...
8010205e:	e8 8d 23 00 00       	call   801043f0 <acquire>
...
801020fe:	e8 bd 21 00 00       	call   801042c0 <holdingsleep>
...
80102138:	e8 b3 22 00 00       	call   801043f0 <acquire>
...
801021be:	68 4a 72 10 80       	push   $0x8010724a
801021c3:	e8 a8 e1 ff ff       	call   80100370 <panic>
    panic("iderw: ide disk 1 not present");
801021c8:	83 ec 0c             	sub    $0xc,%esp
801021cb:	68 75 72 10 80       	push   $0x80107275
801021d0:	e8 9b e1 ff ff       	call   80100370 <panic>
    panic("iderw: nothing to do");
801021d5:	83 ec 0c             	sub    $0xc,%esp
801021d8:	68 60 72 10 80       	push   $0x80107260
...
8010223a:	68 94 72 10 80       	push   $0x80107294
...
80102358:	e8 93 20 00 00       	call   801043f0 <acquire>
8010235d:	83 c4 10             	add    $0x10,%esp
80102360:	eb c2                	jmp    80102324 <kfree+0x44>
    panic("kfree");
80102362:	83 ec 0c             	sub    $0xc,%esp
80102365:	68 c6 72 10 80       	push   $0x801072c6
...
801023cb:	68 cc 72 10 80       	push   $0x801072cc
...
8010253f:	0f b6 8a 00 74 10 80 	movzbl -0x7fef8c00(%edx),%ecx
  shift ^= togglecode[data];
80102546:	0f b6 82 00 73 10 80 	movzbl -0x7fef8d00(%edx),%eax
  shift |= shiftcode[data];
...
8010255c:	83 e1 08             	and    $0x8,%ecx
  c = charcode[shift & (CTL | SHIFT)][data];
8010255f:	8b 04 85 e0 72 10 80 	mov    -0x7fef8d20(,%eax,4),%eax
...
8010258c:	0f 44 d0             	cmove  %eax,%edx
    shift &= ~(shiftcode[data] | E0ESC);
8010258f:	0f b6 82 00 74 10 80 	movzbl -0x7fef8c00(%edx),%eax
...
80102907:	e8 a4 1c 00 00       	call   801045b0 <memcmp>
...
80102a34:	e8 d7 1b 00 00       	call   80104610 <memmove>
...
80102ada:	68 00 75 10 80       	push   $0x80107500
80102adf:	68 80 26 11 80       	push   $0x80112680
80102ae4:	e8 07 18 00 00       	call   801042f0 <initlock>
  readsb(dev, &sb);
80102ae9:	58                   	pop    %eax
...
80102b7b:	e8 70 18 00 00       	call   801043f0 <acquire>
...
80102bcc:	e8 3f 19 00 00       	call   80104510 <release>
      break;
    }
  }
}
...
80102bee:	e8 fd 17 00 00       	call   801043f0 <acquire>
  log.outstanding -= 1;
...
80102c2c:	e8 df 18 00 00       	call   80104510 <release>
}
...
80102c8c:	e8 7f 19 00 00       	call   80104610 <memmove>
...
80102cd5:	e8 16 17 00 00       	call   801043f0 <acquire>
    wakeup(&log);
...
80102ce8:	00 00 00 
    wakeup(&log);
80102ceb:	e8 40 13 00 00       	call   80104030 <wakeup>
    release(&log.lock);
80102cf0:	c7 04 24 80 26 11 80 	movl   $0x80112680,(%esp)
80102cf7:	e8 14 18 00 00       	call   80104510 <release>
...
80102d18:	e8 13 13 00 00       	call   80104030 <wakeup>
  release(&log.lock);
80102d1d:	c7 04 24 80 26 11 80 	movl   $0x80112680,(%esp)
80102d24:	e8 e7 17 00 00       	call   80104510 <release>
...
80102d37:	68 04 75 10 80       	push   $0x80107504
...
80102d8e:	e8 5d 16 00 00       	call   801043f0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102ddc:	c9                   	leave  
  release(&log.lock);
80102ddd:	e9 2e 17 00 00       	jmp    80104510 <release>
...
80102e03:	68 13 75 10 80       	push   $0x80107513
80102e08:	e8 63 d5 ff ff       	call   80100370 <panic>
    panic("log_write outside of trans");
80102e0d:	83 ec 0c             	sub    $0xc,%esp
80102e10:	68 29 75 10 80       	push   $0x80107529
...
80102e38:	68 44 75 10 80       	push   $0x80107544
80102e3d:	e8 1e d8 ff ff       	call   80100660 <cprintf>
  idtinit();       // load idt register
80102e42:	e8 29 2a 00 00       	call   80105870 <idtinit>
...
80102e63:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e66:	e8 45 3b 00 00       	call   801069b0 <switchkvm>
  seginit();
80102e6b:	e8 40 3a 00 00       	call   801068b0 <seginit>
  lapicinit();
...
80102ec9:	e8 b2 2c 00 00       	call   80105b80 <uartinit>
  pinit();         // process table
80102ece:	e8 fd 07 00 00       	call   801036d0 <pinit>
  tvinit();        // trap vectors
80102ed3:	e8 f8 28 00 00       	call   801057d0 <tvinit>
  binit();         // buffer cache
...
80102ef9:	e8 12 17 00 00       	call   80104610 <memmove>
  for(c = cpus; c < cpus+ncpu; c++){
...
80102fc8:	68 58 75 10 80       	push   $0x80107558
80102fcd:	56                   	push   %esi
80102fce:	e8 dd 15 00 00       	call   801045b0 <memcmp>
...
8010307c:	68 75 75 10 80       	push   $0x80107575
80103081:	56                   	push   %esi
80103082:	e8 29 15 00 00       	call   801045b0 <memcmp>
...
80103110:	ff 24 95 9c 75 10 80 	jmp    *-0x7fef8a64(,%edx,4)
...
801031b7:	68 5d 75 10 80       	push   $0x8010755d
801031bc:	e8 af d1 ff ff       	call   80100370 <panic>
    panic("Didn't find a suitable machine");
801031c1:	83 ec 0c             	sub    $0xc,%esp
801031c4:	68 7c 75 10 80       	push   $0x8010757c
...
80103270:	00 00 00 
  initlock(&p->lock, "pipe");
80103273:	68 b0 75 10 80       	push   $0x801075b0
80103278:	50                   	push   %eax
80103279:	e8 72 10 00 00       	call   801042f0 <initlock>
  (*f0)->type = FD_PIPE;
...
8010330f:	e8 dc 10 00 00       	call   801043f0 <acquire>
  if(writable){
...
8010332f:	e8 fc 0c 00 00       	call   80104030 <wakeup>
...
80103353:	5d                   	pop    %ebp
    release(&p->lock);
80103354:	e9 b7 11 00 00       	jmp    80104510 <release>
...
80103374:	e8 b7 0c 00 00       	call   80104030 <wakeup>
...
80103384:	e8 87 11 00 00       	call   80104510 <release>
    kfree((char*)p);
...
801033ad:	e8 3e 10 00 00       	call   801043f0 <acquire>
  for(i = 0; i < n; i++){
...
80103404:	e8 27 0c 00 00       	call   80104030 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103409:	5a                   	pop    %edx
8010340a:	59                   	pop    %ecx
...
80103444:	e8 c7 10 00 00       	call   80104510 <release>
        return -1;
...
80103494:	e8 97 0b 00 00       	call   80104030 <wakeup>
  release(&p->lock);
80103499:	89 1c 24             	mov    %ebx,(%esp)
8010349c:	e8 6f 10 00 00       	call   80104510 <release>
  return n;
...
801034c0:	e8 2b 0f 00 00       	call   801043f0 <acquire>
...
8010352e:	e8 dd 0f 00 00       	call   80104510 <release>
      return -1;
...
8010358f:	e8 7c 0f 00 00       	call   80104510 <release>
  return i;
...
801035c1:	e8 2a 0e 00 00       	call   801043f0 <acquire>
...
80103624:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103627:	c7 40 14 c2 57 10 80 	movl   $0x801057c2,0x14(%eax)
  p->context = (struct context*)sp;
...
8010365a:	e8 b1 0e 00 00       	call   80104510 <release>
}
...
8010368b:	e8 80 0e 00 00       	call   80104510 <release>
...
80103750:	68 bc 75 10 80       	push   $0x801075bc
80103755:	e8 16 cc ff ff       	call   80100370 <panic>
    panic("mycpu called with interrupts enabled\n");
8010375a:	83 ec 0c             	sub    $0xc,%esp
8010375d:	68 98 76 10 80       	push   $0x80107698
...
80103794:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103797:	e8 14 0c 00 00       	call   801043b0 <pushcli>
  c = mycpu();
8010379c:	e8 4f ff ff ff       	call   801036f0 <mycpu>
  p = c->proc;
801037a1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801037a7:	e8 f4 0c 00 00       	call   801044a0 <popcli>
}
...
801037d3:	e8 e8 35 00 00       	call   80106dc0 <setupkvm>
...
801037f1:	e8 ea 32 00 00       	call   80106ae0 <inituvm>
...
80103806:	e8 55 0d 00 00       	call   80104560 <memset>
...
80103865:	e8 d6 0e 00 00       	call   80104740 <safestrcpy>
  p->cwd = namei("/");
...
801038b5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
801038b8:	e8 f3 0a 00 00       	call   801043b0 <pushcli>
  c = mycpu();
801038bd:	e8 2e fe ff ff       	call   801036f0 <mycpu>
  p = c->proc;
801038c2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801038c8:	e8 d3 0b 00 00       	call   801044a0 <popcli>
  if(n > 0){
...
801038de:	e8 3d 33 00 00       	call   80106c20 <allocuvm>
...
801038f0:	e8 db 30 00 00       	call   801069d0 <switchuvm>
  return 0;
...
80103914:	e8 f7 33 00 00       	call   80106d10 <deallocuvm>
...
80103936:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103939:	e8 72 0a 00 00       	call   801043b0 <pushcli>
  c = mycpu();
8010393e:	e8 ad fd ff ff       	call   801036f0 <mycpu>
  p = c->proc;
80103943:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103949:	e8 52 0b 00 00       	call   801044a0 <popcli>
  if((np = allocproc()) == 0){
...
80103968:	e8 23 35 00 00       	call   80106e90 <copyuvm>
...
80103a7e:	e8 6d 09 00 00       	call   801043f0 <acquire>
...
80103aab:	83 eb 80             	sub    $0xffffff80,%ebx
      switchuvm(p);
80103aae:	e8 1d 2f 00 00       	call   801069d0 <switchuvm>
...
80103ab9:	c7 43 8c 04 00 00 00 	movl   $0x4,-0x74(%ebx)
      swtch(&(c->scheduler), p->context);
80103ac0:	e8 d6 0c 00 00       	call   8010479b <swtch>
      switchkvm();
80103ac5:	e8 e6 2e 00 00       	call   801069b0 <switchkvm>
      c->proc = 0;
...
80103ae8:	e8 23 0a 00 00       	call   80104510 <release>
    sti();
...
80103b63:	e8 33 0c 00 00       	call   8010479b <swtch>
  mycpu()->intena = intena;
...
80103bc6:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103bc9:	e8 e2 07 00 00       	call   801043b0 <pushcli>
  c = mycpu();
80103bce:	e8 1d fb ff ff       	call   801036f0 <mycpu>
  p = c->proc;
80103bd3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103bd9:	e8 c2 08 00 00       	call   801044a0 <popcli>
  if(curproc == initproc)
80103bde:	39 35 b8 a5 10 80    	cmp    %esi,0x8010a5b8
  curproc->status = status;
80103be4:	8b 45 08             	mov    0x8(%ebp),%eax
80103be7:	8d 5e 28             	lea    0x28(%esi),%ebx
80103bea:	8d 7e 68             	lea    0x68(%esi),%edi
80103bed:	89 46 7c             	mov    %eax,0x7c(%esi)
  if(curproc == initproc)
80103bf0:	0f 84 f1 00 00 00    	je     80103ce7 <exit+0x127>
...
80103c04:	74 12                	je     80103c18 <exit+0x58>
...
80103c1d:	75 e1                	jne    80103c00 <exit+0x40>
  begin_op();
...
80103c42:	e8 a9 07 00 00       	call   801043f0 <acquire>
...
80103c7c:	72 e4                	jb     80103c62 <exit+0xa2>
      p->parent = initproc;
...
80103c99:	73 33                	jae    80103cce <exit+0x10e>
    if(p->parent == curproc){
...
80103cb8:	73 d6                	jae    80103c90 <exit+0xd0>
    if(p->state == SLEEPING && p->chan == chan)
...
80103cdd:	68 3d 76 10 80       	push   $0x8010763d
80103ce2:	e8 89 c6 ff ff       	call   80100370 <panic>
    panic("init exiting");
80103ce7:	83 ec 0c             	sub    $0xc,%esp
80103cea:	68 30 76 10 80       	push   $0x80107630
...
80103d0c:	e8 df 06 00 00       	call   801043f0 <acquire>
  pushcli();
80103d11:	e8 9a 06 00 00       	call   801043b0 <pushcli>
  c = mycpu();
80103d16:	e8 d5 f9 ff ff       	call   801036f0 <mycpu>
  p = c->proc;
80103d1b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d21:	e8 7a 07 00 00       	call   801044a0 <popcli>
...
80103d39:	e8 d2 07 00 00       	call   80104510 <release>
}
...
80103d5c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103d5f:	e8 4c 06 00 00       	call   801043b0 <pushcli>
  c = mycpu();
80103d64:	e8 87 f9 ff ff       	call   801036f0 <mycpu>
  p = c->proc;
80103d69:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d6f:	e8 2c 07 00 00       	call   801044a0 <popcli>
  if(p == 0)
...
80103d90:	e8 5b 06 00 00       	call   801043f0 <acquire>
    release(lk);
80103d95:	89 34 24             	mov    %esi,(%esp)
80103d98:	e8 73 07 00 00       	call   80104510 <release>
  p->chan = chan;
...
80103dba:	e8 51 07 00 00       	call   80104510 <release>
    acquire(lk);
...
80103dcb:	5d                   	pop    %ebp
    acquire(lk);
80103dcc:	e9 1f 06 00 00       	jmp    801043f0 <acquire>
...
80103e14:	53                   	push   %ebx
  pushcli();
80103e15:	e8 96 05 00 00       	call   801043b0 <pushcli>
  c = mycpu();
80103e1a:	e8 d1 f8 ff ff       	call   801036f0 <mycpu>
  p = c->proc;
80103e1f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103e25:	e8 76 06 00 00       	call   801044a0 <popcli>
  curproc->status = *status;
80103e2a:	8b 45 08             	mov    0x8(%ebp),%eax
  acquire(&ptable.lock);
80103e2d:	83 ec 0c             	sub    $0xc,%esp
  curproc->status = *status;
80103e30:	8b 00                	mov    (%eax),%eax
80103e32:	89 46 7c             	mov    %eax,0x7c(%esi)
  acquire(&ptable.lock);
80103e35:	68 20 2d 11 80       	push   $0x80112d20
80103e3a:	e8 b1 05 00 00       	call   801043f0 <acquire>
80103e3f:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
80103e42:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e44:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103e49:	eb 10                	jmp    80103e5b <wait+0x4b>
80103e4b:	90                   	nop
80103e4c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103e50:	83 eb 80             	sub    $0xffffff80,%ebx
80103e53:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
80103e59:	73 25                	jae    80103e80 <wait+0x70>
      if(p->parent != curproc)
80103e5b:	39 73 14             	cmp    %esi,0x14(%ebx)
80103e5e:	75 f0                	jne    80103e50 <wait+0x40>
      if(p->state == ZOMBIE){
80103e60:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80103e64:	74 38                	je     80103e9e <wait+0x8e>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e66:	83 eb 80             	sub    $0xffffff80,%ebx
      havekids = 1;
80103e69:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e6e:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
80103e74:	72 e5                	jb     80103e5b <wait+0x4b>
80103e76:	8d 76 00             	lea    0x0(%esi),%esi
80103e79:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    if(!havekids || curproc->killed){
80103e80:	85 c0                	test   %eax,%eax
80103e82:	74 70                	je     80103ef4 <wait+0xe4>
80103e84:	8b 46 24             	mov    0x24(%esi),%eax
80103e87:	85 c0                	test   %eax,%eax
80103e89:	75 69                	jne    80103ef4 <wait+0xe4>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
80103e8b:	83 ec 08             	sub    $0x8,%esp
80103e8e:	68 20 2d 11 80       	push   $0x80112d20
80103e93:	56                   	push   %esi
80103e94:	e8 b7 fe ff ff       	call   80103d50 <sleep>
    havekids = 0;
80103e99:	83 c4 10             	add    $0x10,%esp
80103e9c:	eb a4                	jmp    80103e42 <wait+0x32>
        kfree(p->kstack);
...
80103eb0:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103eb7:	e8 84 2e 00 00       	call   80106d40 <freevm>
        p->pid = 0;
...
80103ee3:	e8 28 06 00 00       	call   80104510 <release>
        return pid;
...
80103f01:	e8 0a 06 00 00       	call   80104510 <release>
      return -1;
...
80103f26:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103f29:	e8 82 04 00 00       	call   801043b0 <pushcli>
  c = mycpu();
80103f2e:	e8 bd f7 ff ff       	call   801036f0 <mycpu>
  p = c->proc;
80103f33:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103f39:	e8 62 05 00 00       	call   801044a0 <popcli>
  curproc->status = *status;
...
80103f46:	89 46 7c             	mov    %eax,0x7c(%esi)
  curproc->pid = pid;
80103f49:	8b 45 08             	mov    0x8(%ebp),%eax
80103f4c:	89 46 10             	mov    %eax,0x10(%esi)
  acquire(&ptable.lock);
80103f4f:	68 20 2d 11 80       	push   $0x80112d20
80103f54:	e8 97 04 00 00       	call   801043f0 <acquire>
80103f59:	83 c4 10             	add    $0x10,%esp
    pfound = 0;
80103f5c:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f5e:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103f63:	eb 0e                	jmp    80103f73 <waitpid+0x53>
80103f65:	8d 76 00             	lea    0x0(%esi),%esi
80103f68:	83 eb 80             	sub    $0xffffff80,%ebx
80103f6b:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
80103f71:	73 1d                	jae    80103f90 <waitpid+0x70>
      if(p->parent != curproc)
80103f73:	39 73 14             	cmp    %esi,0x14(%ebx)
80103f76:	75 f0                	jne    80103f68 <waitpid+0x48>
      if(p->pid == curproc->pid){
80103f78:	8b 7b 10             	mov    0x10(%ebx),%edi
80103f7b:	3b 7e 10             	cmp    0x10(%esi),%edi
80103f7e:	74 2e                	je     80103fae <waitpid+0x8e>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f80:	83 eb 80             	sub    $0xffffff80,%ebx
      pfound = 1;
80103f83:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f88:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
80103f8e:	72 e3                	jb     80103f73 <waitpid+0x53>
    if(!pfound || curproc->killed){
80103f90:	85 c0                	test   %eax,%eax
80103f92:	74 6e                	je     80104002 <waitpid+0xe2>
80103f94:	8b 46 24             	mov    0x24(%esi),%eax
80103f97:	85 c0                	test   %eax,%eax
80103f99:	75 67                	jne    80104002 <waitpid+0xe2>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
80103f9b:	83 ec 08             	sub    $0x8,%esp
80103f9e:	68 20 2d 11 80       	push   $0x80112d20
80103fa3:	56                   	push   %esi
80103fa4:	e8 a7 fd ff ff       	call   80103d50 <sleep>
    pfound = 0;
80103fa9:	83 c4 10             	add    $0x10,%esp
80103fac:	eb ae                	jmp    80103f5c <waitpid+0x3c>
        kfree(p->kstack);
80103fae:	83 ec 0c             	sub    $0xc,%esp
80103fb1:	ff 73 08             	pushl  0x8(%ebx)
80103fb4:	e8 27 e3 ff ff       	call   801022e0 <kfree>
        freevm(p->pgdir);
80103fb9:	5a                   	pop    %edx
80103fba:	ff 73 04             	pushl  0x4(%ebx)
        p->kstack = 0;
80103fbd:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103fc4:	e8 77 2d 00 00       	call   80106d40 <freevm>
        p->pid = 0;
80103fc9:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80103fd0:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80103fd7:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
80103fdb:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
80103fe2:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103fe9:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103ff0:	e8 1b 05 00 00       	call   80104510 <release>
        return pid;
...
80104002:	83 ec 0c             	sub    $0xc,%esp
      return -1;
80104005:	bf ff ff ff ff       	mov    $0xffffffff,%edi
      release(&ptable.lock);
8010400a:	68 20 2d 11 80       	push   $0x80112d20
8010400f:	e8 fc 04 00 00       	call   80104510 <release>
      curproc->pid = -1;
80104014:	c7 46 10 ff ff ff ff 	movl   $0xffffffff,0x10(%esi)
      return -1;
...
8010403f:	e8 ac 03 00 00       	call   801043f0 <acquire>
...
80104080:	c9                   	leave  
  release(&ptable.lock);
80104081:	e9 8a 04 00 00       	jmp    80104510 <release>
...
8010409f:	e8 4c 03 00 00       	call   801043f0 <acquire>
...
801040b8:	73 3e                	jae    801040f8 <kill+0x68>
    if(p->pid == pid){
...
801040c3:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      if(p->state == SLEEPING)
801040ca:	74 1c                	je     801040e8 <kill+0x58>
        p->state = RUNNABLE;
      release(&ptable.lock);
801040cc:	83 ec 0c             	sub    $0xc,%esp
801040cf:	68 20 2d 11 80       	push   $0x80112d20
801040d4:	e8 37 04 00 00       	call   80104510 <release>
      return 0;
801040d9:	83 c4 10             	add    $0x10,%esp
801040dc:	31 c0                	xor    %eax,%eax
    }
  }
  release(&ptable.lock);
  return -1;
...
8010413b:	68 db 79 10 80       	push   $0x801079db
80104140:	e8 1b c5 ff ff       	call   80100660 <cprintf>
80104145:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104148:	83 eb 80             	sub    $0xffffff80,%ebx
8010414b:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
80104151:	0f 83 81 00 00 00    	jae    801041d8 <procdump+0xb8>
    if(p->state == UNUSED)
80104157:	8b 43 0c             	mov    0xc(%ebx),%eax
8010415a:	85 c0                	test   %eax,%eax
8010415c:	74 ea                	je     80104148 <procdump+0x28>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010415e:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104161:	ba 60 76 10 80       	mov    $0x80107660,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104166:	77 11                	ja     80104179 <procdump+0x59>
80104168:	8b 14 85 c0 76 10 80 	mov    -0x7fef8940(,%eax,4),%edx
      state = "???";
8010416f:	b8 60 76 10 80       	mov    $0x80107660,%eax
80104174:	85 d2                	test   %edx,%edx
80104176:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
80104179:	8d 43 6c             	lea    0x6c(%ebx),%eax
8010417c:	50                   	push   %eax
8010417d:	52                   	push   %edx
8010417e:	ff 73 10             	pushl  0x10(%ebx)
80104181:	68 64 76 10 80       	push   $0x80107664
80104186:	e8 d5 c4 ff ff       	call   80100660 <cprintf>
    if(p->state == SLEEPING){
8010418b:	83 c4 10             	add    $0x10,%esp
8010418e:	83 7b 0c 02          	cmpl   $0x2,0xc(%ebx)
...
8010419e:	8b 43 1c             	mov    0x1c(%ebx),%eax
801041a1:	8b 40 0c             	mov    0xc(%eax),%eax
801041a4:	83 c0 08             	add    $0x8,%eax
801041a7:	50                   	push   %eax
801041a8:	e8 63 01 00 00       	call   80104310 <getcallerpcs>
...
801041bd:	68 a1 70 10 80       	push   $0x801070a1
...
801041ea:	68 d8 76 10 80       	push   $0x801076d8
...
80104245:	e8 06 fb ff ff       	call   80103d50 <sleep>
  while (lk->locked) {
...
80104253:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104259:	e8 32 f5 ff ff       	call   80103790 <myproc>
...
801042a4:	e8 87 fd ff ff       	call   80104030 <wakeup>
  release(&lk->lk);
...
80104393:	e8 58 f3 ff ff       	call   801036f0 <mycpu>
...
801043b9:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
801043ba:	e8 31 f3 ff ff       	call   801036f0 <mycpu>
...
801043cf:	e8 1c f3 ff ff       	call   801036f0 <mycpu>
...
801043f5:	e8 b6 ff ff ff       	call   801043b0 <pushcli>
  if(holding(lk))
801043fa:	8b 5d 08             	mov    0x8(%ebp),%ebx
  return lock->locked && lock->cpu == mycpu();
801043fd:	8b 03                	mov    (%ebx),%eax
801043ff:	85 c0                	test   %eax,%eax
80104401:	75 7d                	jne    80104480 <acquire+0x90>
  asm volatile("lock; xchgl %0, %1" :
80104403:	ba 01 00 00 00       	mov    $0x1,%edx
80104408:	eb 09                	jmp    80104413 <acquire+0x23>
...
80104424:	e8 c7 f2 ff ff       	call   801036f0 <mycpu>
  ebp = (uint*)v - 2;
...
80104444:	77 1a                	ja     80104460 <acquire+0x70>
    pcs[i] = ebp[1];     // saved %eip
...
80104454:	75 e2                	jne    80104438 <acquire+0x48>
}
...
8010446d:	74 e7                	je     80104456 <acquire+0x66>
    pcs[i] = 0;
...
8010447e:	eb d6                	jmp    80104456 <acquire+0x66>
  return lock->locked && lock->cpu == mycpu();
80104480:	8b 73 08             	mov    0x8(%ebx),%esi
80104483:	e8 68 f2 ff ff       	call   801036f0 <mycpu>
80104488:	39 c6                	cmp    %eax,%esi
8010448a:	0f 85 73 ff ff ff    	jne    80104403 <acquire+0x13>
    panic("acquire");
80104490:	83 ec 0c             	sub    $0xc,%esp
80104493:	68 e3 76 10 80       	push   $0x801076e3
...
801044ab:	75 52                	jne    801044ff <popcli+0x5f>
    panic("popcli - interruptible");
  if(--mycpu()->ncli < 0)
801044ad:	e8 3e f2 ff ff       	call   801036f0 <mycpu>
801044b2:	8b 88 a4 00 00 00    	mov    0xa4(%eax),%ecx
801044b8:	8d 51 ff             	lea    -0x1(%ecx),%edx
801044bb:	85 d2                	test   %edx,%edx
801044bd:	89 90 a4 00 00 00    	mov    %edx,0xa4(%eax)
801044c3:	78 2d                	js     801044f2 <popcli+0x52>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
801044c5:	e8 26 f2 ff ff       	call   801036f0 <mycpu>
801044ca:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
801044d0:	85 d2                	test   %edx,%edx
801044d2:	74 0c                	je     801044e0 <popcli+0x40>
    sti();
}
801044d4:	c9                   	leave  
801044d5:	c3                   	ret    
...
801044d9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  if(mycpu()->ncli == 0 && mycpu()->intena)
801044e0:	e8 0b f2 ff ff       	call   801036f0 <mycpu>
801044e5:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
801044eb:	85 c0                	test   %eax,%eax
801044ed:	74 e5                	je     801044d4 <popcli+0x34>
  asm volatile("sti");
801044ef:	fb                   	sti    
}
801044f0:	c9                   	leave  
...
801044f5:	68 02 77 10 80       	push   $0x80107702
801044fa:	e8 71 be ff ff       	call   80100370 <panic>
    panic("popcli - interruptible");
801044ff:	83 ec 0c             	sub    $0xc,%esp
80104502:	68 eb 76 10 80       	push   $0x801076eb
80104507:	e8 64 be ff ff       	call   80100370 <panic>
...
80104521:	68 09 77 10 80       	push   $0x80107709
80104526:	e8 45 be ff ff       	call   80100370 <panic>
8010452b:	90                   	nop
8010452c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  return lock->locked && lock->cpu == mycpu();
80104530:	8b 73 08             	mov    0x8(%ebx),%esi
80104533:	e8 b8 f1 ff ff       	call   801036f0 <mycpu>
...
8010455a:	5d                   	pop    %ebp
  popcli();
8010455b:	e9 40 ff ff ff       	jmp    801044a0 <popcli>
...
80104622:	8d 14 33             	lea    (%ebx,%esi,1),%edx
...
801047b7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801047ba:	e8 d1 ef ff ff       	call   80103790 <myproc>
...
801047f7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
801047fa:	e8 91 ef ff ff       	call   80103790 <myproc>
...
80104855:	e8 36 ef ff ff       	call   80103790 <myproc>
...
80104863:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104866:	e8 25 ef ff ff       	call   80103790 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
801048a8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801048ab:	e8 e0 ee ff ff       	call   80103790 <myproc>
...
8010495a:	8b 14 85 40 77 10 80 	mov    -0x7fef88c0(,%eax,4),%edx
...
80104980:	68 11 77 10 80       	push   $0x80107711
...
80104a24:	31 ff                	xor    %edi,%edi
    iunlockput(ip);
80104a26:	e8 d5 ce ff ff       	call   80101900 <iunlockput>
    return 0;
...
80104ac2:	e9 47 ff ff ff       	jmp    80104a0e <create+0x6e>
80104ac7:	89 f6                	mov    %esi,%esi
80104ac9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    dp->nlink++;  // for ".."
80104ad0:	66 83 46 56 01       	addw   $0x1,0x56(%esi)
    iupdate(dp);
...
80104ae4:	68 b8 77 10 80       	push   $0x801077b8
...
80104afc:	68 b7 77 10 80       	push   $0x801077b7
...
80104b64:	e8 27 ec ff ff       	call   80103790 <myproc>
...
80104bc8:	8b 75 f4             	mov    -0xc(%ebp),%esi
  struct proc *curproc = myproc();
80104bcb:	e8 c0 eb ff ff       	call   80103790 <myproc>
...
80104bfa:	e8 d1 c1 ff ff       	call   80100dd0 <filedup>
  return fd;
...
80104ccd:	e8 fe c2 ff ff       	call   80100fd0 <filewrite>
...
80104d03:	78 2b                	js     80104d30 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104d05:	e8 86 ea ff ff       	call   80103790 <myproc>
...
80104d1b:	e8 00 c1 ff ff       	call   80100e20 <fileclose>
  return 0;
...
80104d74:	e8 77 c1 ff ff       	call   80100ef0 <filestat>
...
80104dc2:	0f 88 e2 00 00 00    	js     80104eaa <sys_link+0x11a>
  begin_op();
80104dc8:	e8 a3 dd ff ff       	call   80102b70 <begin_op>
  if((ip = namei(old)) == 0){
...
80104e5b:	e8 40 c9 ff ff       	call   801017a0 <iput>
  end_op();
80104e60:	e8 7b dd ff ff       	call   80102be0 <end_op>
  return 0;
...
80104e9d:	e8 5e ca ff ff       	call   80101900 <iunlockput>
  end_op();
80104ea2:	e8 39 dd ff ff       	call   80102be0 <end_op>
  return -1;
...
80104f0f:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  begin_op();
80104f12:	e8 59 dc ff ff       	call   80102b70 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
80104f3d:	58                   	pop    %eax
80104f3e:	5a                   	pop    %edx
80104f3f:	68 b8 77 10 80       	push   $0x801077b8
...
80104f58:	68 b7 77 10 80       	push   $0x801077b7
...
80104fb2:	e8 a9 f5 ff ff       	call   80104560 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80104ff7:	e8 04 c9 ff ff       	call   80101900 <iunlockput>
  end_op();
80104ffc:	e8 df db ff ff       	call   80102be0 <end_op>
  return 0;
...
80105057:	e8 a4 c8 ff ff       	call   80101900 <iunlockput>
  end_op();
8010505c:	e8 7f db ff ff       	call   80102be0 <end_op>
  return -1;
...
80105096:	e9 6b ff ff ff       	jmp    80105006 <sys_unlink+0x116>
    end_op();
8010509b:	e8 40 db ff ff       	call   80102be0 <end_op>
    return -1;
...
80105112:	0f 88 85 00 00 00    	js     8010519d <sys_open+0xbd>
  ...
  begin_op();
80105118:	e8 53 da ff ff       	call   80102b70 <begin_op>
...
80105156:	e8 05 bc ff ff       	call   80100d60 <filealloc>
...
80105161:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105163:	e8 28 e6 ff ff       	call   80103790 <myproc>
80105168:	90                   	nop
...
80105184:	e8 97 bc ff ff       	call   80100e20 <fileclose>
...
80105190:	e8 6b c7 ff ff       	call   80101900 <iunlockput>
    end_op();
80105195:	e8 46 da ff ff       	call   80102be0 <end_op>
    return -1;
...
8010519d:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return -1;
801051a0:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
}
...
801051cb:	75 89                	jne    80105156 <sys_open+0x76>
      end_op();
801051cd:	e8 0e da ff ff       	call   80102be0 <end_op>
      return -1;
801051d2:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801051d7:	eb 40                	jmp    80105219 <sys_open+0x139>
...
801051e8:	e8 63 c5 ff ff       	call   80101750 <iunlock>
  end_op();
801051ed:	e8 ee d9 ff ff       	call   80102be0 <end_op>
  f->type = FD_INODE;
...
80105201:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
  f->readable = !(omode & O_WRONLY);
80105208:	89 c2                	mov    %eax,%edx
8010520a:	f7 d2                	not    %edx
8010520c:	88 57 08             	mov    %dl,0x8(%edi)
8010520f:	80 67 08 01          	andb   $0x1,0x8(%edi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105213:	a8 03                	test   $0x3,%al
80105215:	0f 95 47 09          	setne  0x9(%edi)
}
...
80105243:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105246:	e8 25 d9 ff ff       	call   80102b70 <begin_op>
...
8010527f:	e8 7c c6 ff ff       	call   80101900 <iunlockput>
  end_op();
80105284:	e8 57 d9 ff ff       	call   80102be0 <end_op>
  return 0;
...
8010528f:	c3                   	ret    
    end_op();
80105290:	e8 4b d9 ff ff       	call   80102be0 <end_op>
    return -1;
...
801052a3:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
801052a6:	e8 c5 d8 ff ff       	call   80102b70 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
8010530e:	e8 ed c5 ff ff       	call   80101900 <iunlockput>
  end_op();
80105313:	e8 c8 d8 ff ff       	call   80102be0 <end_op>
  return 0;
...
8010531f:	90                   	nop
    end_op();
80105320:	e8 bb d8 ff ff       	call   80102be0 <end_op>
    return -1;
...
80105335:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105338:	e8 53 e4 ff ff       	call   80103790 <myproc>
8010533d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010533f:	e8 2c d8 ff ff       	call   80102b70 <begin_op>
...
8010538d:	e8 0e c4 ff ff       	call   801017a0 <iput>
  end_op();
80105392:	e8 49 d8 ff ff       	call   80102be0 <end_op>
  curproc->cwd = ip;
...
801053b4:	e8 47 c5 ff ff       	call   80101900 <iunlockput>
    end_op();
801053b9:	e8 22 d8 ff ff       	call   80102be0 <end_op>
    return -1;
...
801053c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    end_op();
801053d0:	e8 0b d8 ff ff       	call   80102be0 <end_op>
    return -1;
...
80105438:	e8 23 f1 ff ff       	call   80104560 <memset>
...
801054ab:	e8 30 b5 ff ff       	call   801009e0 <exec>
...
801054e8:	e8 13 dd ff ff       	call   80103200 <pipealloc>
...
801054f6:	8b 7d e0             	mov    -0x20(%ebp),%edi
  struct proc *curproc = myproc();
801054f9:	e8 92 e2 ff ff       	call   80103790 <myproc>
...
80105516:	e8 05 b9 ff ff       	call   80100e20 <fileclose>
    fileclose(wf);
8010551b:	58                   	pop    %eax
8010551c:	ff 75 e4             	pushl  -0x1c(%ebp)
8010551f:	e8 fc b8 ff ff       	call   80100e20 <fileclose>
    return -1;
...
8010553f:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
80105542:	e8 49 e2 ff ff       	call   80103790 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
8010555e:	75 f0                	jne    80105550 <sys_pipe+0x90>
      myproc()->ofile[fd0] = 0;
80105560:	e8 2b e2 ff ff       	call   80103790 <myproc>
...
80105593:	5d                   	pop    %ebp
  return fork();
80105594:	e9 97 e3 ff ff       	jmp    80103930 <fork>
...
801055b5:	e8 06 e6 ff ff       	call   80103bc0 <exit>
  //exit();
  return 0;  // not reached
}
801055ba:	31 c0                	xor    %eax,%eax
801055bc:	c9                   	leave  
801055bd:	c3                   	ret    
...
801055c9:	6a 04                	push   $0x4
801055cb:	50                   	push   %eax
801055cc:	6a 00                	push   $0x0
801055ce:	e8 cd f2 ff ff       	call   801048a0 <argptr>
  return wait(status);
801055d3:	58                   	pop    %eax
801055d4:	ff 75 f4             	pushl  -0xc(%ebp)
801055d7:	e8 34 e8 ff ff       	call   80103e10 <wait>
}
801055dc:	c9                   	leave  
801055dd:	c3                   	ret    
...
801055ec:	e8 5f f2 ff ff       	call   80104850 <argint>
  argptr(0, (char **) &status, sizeof(int*));
801055f1:	8d 45 f0             	lea    -0x10(%ebp),%eax
801055f4:	83 c4 0c             	add    $0xc,%esp
801055f7:	6a 04                	push   $0x4
801055f9:	50                   	push   %eax
801055fa:	6a 00                	push   $0x0
801055fc:	e8 9f f2 ff ff       	call   801048a0 <argptr>
  argint(0, &options);
80105601:	58                   	pop    %eax
...
80105609:	e8 42 f2 ff ff       	call   80104850 <argint>
  return waitpid(pid, status, options);
8010560e:	83 c4 0c             	add    $0xc,%esp
80105611:	ff 75 f4             	pushl  -0xc(%ebp)
80105614:	ff 75 f0             	pushl  -0x10(%ebp)
80105617:	ff 75 ec             	pushl  -0x14(%ebp)
8010561a:	e8 01 e9 ff ff       	call   80103f20 <waitpid>
}
8010561f:	c9                   	leave  
80105620:	c3                   	ret    
80105621:	eb 0d                	jmp    80105630 <sys_kill>
80105623:	90                   	nop
80105624:	90                   	nop
80105625:	90                   	nop
80105626:	90                   	nop
...
8010563c:	e8 0f f2 ff ff       	call   80104850 <argint>
...
801056dd:	e8 6e f1 ff ff       	call   80104850 <argint>
...
801056f5:	e8 f6 ec ff ff       	call   801043f0 <acquire>
  ticks0 = ticks;
...
8010571d:	e8 2e e6 ff ff       	call   80103d50 <sleep>
  while(ticks - ticks0 < n){
...
80105745:	e8 c6 ed ff ff       	call   80104510 <release>
      return -1;
...
80105768:	e8 a3 ed ff ff       	call   80104510 <release>
  return 0;
...
801057b9:	54                   	push   %esp
  call trap
801057ba:	e8 e1 00 00 00       	call   801058a0 <trap>
  addl $4, %esp
...
801057e7:	b9 08 00 00 00       	mov    $0x8,%ecx
801057ec:	c6 04 c5 a4 4d 11 80 	movb   $0x0,-0x7feeb25c(,%eax,8)
801057f3:	00 
801057f4:	66 89 0c c5 a2 4d 11 	mov    %cx,-0x7feeb25e(,%eax,8)
801057fb:	80 
801057fc:	c6 04 c5 a5 4d 11 80 	movb   $0x8e,-0x7feeb25b(,%eax,8)
80105803:	8e 
80105804:	66 89 14 c5 a0 4d 11 	mov    %dx,-0x7feeb260(,%eax,8)
8010580b:	80 
8010580c:	c1 ea 10             	shr    $0x10,%edx
8010580f:	66 89 14 c5 a6 4d 11 	mov    %dx,-0x7feeb25a(,%eax,8)
80105816:	80 
  for(i = 0; i < 256; i++)
80105817:	83 c0 01             	add    $0x1,%eax
8010581a:	3d 00 01 00 00       	cmp    $0x100,%eax
8010581f:	75 bf                	jne    801057e0 <tvinit+0x10>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105821:	a1 08 a1 10 80       	mov    0x8010a108,%eax

  initlock(&tickslock, "time");
80105826:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105829:	ba 08 00 00 00       	mov    $0x8,%edx
  initlock(&tickslock, "time");
8010582e:	68 fd 77 10 80       	push   $0x801077fd
80105833:	68 60 4d 11 80       	push   $0x80114d60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105838:	66 89 15 a2 4f 11 80 	mov    %dx,0x80114fa2
8010583f:	c6 05 a4 4f 11 80 00 	movb   $0x0,0x80114fa4
80105846:	66 a3 a0 4f 11 80    	mov    %ax,0x80114fa0
8010584c:	c1 e8 10             	shr    $0x10,%eax
8010584f:	c6 05 a5 4f 11 80 ef 	movb   $0xef,0x80114fa5
80105856:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
8010585c:	e8 8f ea ff ff       	call   801042f0 <initlock>
}
...
801058b2:	0f 84 98 01 00 00    	je     80105a50 <trap+0x1b0>
    if(myproc()->killed)
      exit(0);
    return;
  }
...
801058d0:	e8 bb de ff ff       	call   80103790 <myproc>
801058d5:	85 c0                	test   %eax,%eax
801058d7:	0f 84 f7 01 00 00    	je     80105ad4 <trap+0x234>
801058dd:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
801058e1:	0f 84 ed 01 00 00    	je     80105ad4 <trap+0x234>
...
80105932:	e8 59 de ff ff       	call   80103790 <myproc>
...
80105955:	e8 36 de ff ff       	call   80103790 <myproc>
8010595a:	85 c0                	test   %eax,%eax
8010595c:	74 0b                	je     80105969 <trap+0xc9>
8010595e:	e8 2d de ff ff       	call   80103790 <myproc>
80105963:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105967:	74 57                	je     801059c0 <trap+0x120>
...
80105972:	e8 19 de ff ff       	call   80103790 <myproc>
...
80105989:	0f 84 ea 00 00 00    	je     80105a79 <trap+0x1d9>
    exit(0);
}
...
801059b2:	e8 09 e2 ff ff       	call   80103bc0 <exit>
801059b7:	83 c4 10             	add    $0x10,%esp
801059ba:	eb 99                	jmp    80105955 <trap+0xb5>
801059bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(myproc() && myproc()->state == RUNNING &&
801059c0:	83 7f 30 20          	cmpl   $0x20,0x30(%edi)
801059c4:	75 a3                	jne    80105969 <trap+0xc9>
    yield();
801059c6:	e8 35 e3 ff ff       	call   80103d00 <yield>
801059cb:	eb 9c                	jmp    80105969 <trap+0xc9>
801059cd:	8d 76 00             	lea    0x0(%esi),%esi
    if(cpuid() == 0){
801059d0:	e8 9b dd ff ff       	call   80103770 <cpuid>
801059d5:	85 c0                	test   %eax,%eax
801059d7:	0f 84 c3 00 00 00    	je     80105aa0 <trap+0x200>
    lapiceoi();
801059dd:	e8 3e cd ff ff       	call   80102720 <lapiceoi>
    break;
801059e2:	e9 59 ff ff ff       	jmp    80105940 <trap+0xa0>
801059e7:	89 f6                	mov    %esi,%esi
801059e9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    kbdintr();
801059f0:	e8 eb cb ff ff       	call   801025e0 <kbdintr>
    lapiceoi();
801059f5:	e8 26 cd ff ff       	call   80102720 <lapiceoi>
    break;
801059fa:	e9 41 ff ff ff       	jmp    80105940 <trap+0xa0>
801059ff:	90                   	nop
    uartintr();
80105a00:	e8 6b 02 00 00       	call   80105c70 <uartintr>
    lapiceoi();
80105a05:	e8 16 cd ff ff       	call   80102720 <lapiceoi>
    break;
80105a0a:	e9 31 ff ff ff       	jmp    80105940 <trap+0xa0>
80105a0f:	90                   	nop
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105a10:	0f b7 5f 3c          	movzwl 0x3c(%edi),%ebx
80105a14:	8b 77 38             	mov    0x38(%edi),%esi
80105a17:	e8 54 dd ff ff       	call   80103770 <cpuid>
80105a1c:	56                   	push   %esi
80105a1d:	53                   	push   %ebx
80105a1e:	50                   	push   %eax
80105a1f:	68 08 78 10 80       	push   $0x80107808
80105a24:	e8 37 ac ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105a29:	e8 f2 cc ff ff       	call   80102720 <lapiceoi>
    break;
80105a2e:	83 c4 10             	add    $0x10,%esp
80105a31:	e9 0a ff ff ff       	jmp    80105940 <trap+0xa0>
80105a36:	8d 76 00             	lea    0x0(%esi),%esi
80105a39:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    ideintr();
80105a40:	e8 0b c6 ff ff       	call   80102050 <ideintr>
80105a45:	eb 96                	jmp    801059dd <trap+0x13d>
80105a47:	89 f6                	mov    %esi,%esi
80105a49:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    if(myproc()->killed)
80105a50:	e8 3b dd ff ff       	call   80103790 <myproc>
80105a55:	8b 58 24             	mov    0x24(%eax),%ebx
80105a58:	85 db                	test   %ebx,%ebx
80105a5a:	75 34                	jne    80105a90 <trap+0x1f0>
    myproc()->tf = tf;
80105a5c:	e8 2f dd ff ff       	call   80103790 <myproc>
80105a61:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105a64:	e8 d7 ee ff ff       	call   80104940 <syscall>
    if(myproc()->killed)
80105a69:	e8 22 dd ff ff       	call   80103790 <myproc>
80105a6e:	8b 48 24             	mov    0x24(%eax),%ecx
80105a71:	85 c9                	test   %ecx,%ecx
80105a73:	0f 84 16 ff ff ff    	je     8010598f <trap+0xef>
      exit(0);
80105a79:	c7 45 08 00 00 00 00 	movl   $0x0,0x8(%ebp)
}
...
80105b55:	e8 e6 cb ff ff       	call   80102740 <microdelay>
...
80105bef:	bb 24 79 10 80       	mov    $0x80107924,%ebx
80105bf4:	6a 00                	push   $0x0
80105bf6:	6a 04                	push   $0x4
80105bf8:	e8 a3 c6 ff ff       	call   801022a0 <ioapicenable>
...
80105c7b:	e8 60 ab ff ff       	call   801007e0 <consoleintr>
}
...
80106744:	e8 47 bd ff ff       	call   80102490 <kalloc>
...
8010675a:	e8 01 de ff ff       	call   80104560 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801067fd:	68 2c 79 10 80       	push   $0x8010792c
...
80106854:	e8 87 ba ff ff       	call   801022e0 <kfree>
      *pte = 0;
...
801068a2:	68 c6 72 10 80       	push   $0x801072c6
...
801068b3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801068b6:	e8 b5 ce ff ff       	call   80103770 <cpuid>
...
801068c8:	66 89 90 f8 27 11 80 	mov    %dx,-0x7feed808(%eax)
801068cf:	66 89 88 fa 27 11 80 	mov    %cx,-0x7feed806(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801068d6:	ba ff ff ff ff       	mov    $0xffffffff,%edx
801068db:	31 c9                	xor    %ecx,%ecx
801068dd:	66 89 90 00 28 11 80 	mov    %dx,-0x7feed800(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801068e4:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801068e9:	66 89 88 02 28 11 80 	mov    %cx,-0x7feed7fe(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801068f0:	31 c9                	xor    %ecx,%ecx
801068f2:	66 89 90 08 28 11 80 	mov    %dx,-0x7feed7f8(%eax)
801068f9:	66 89 88 0a 28 11 80 	mov    %cx,-0x7feed7f6(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106900:	ba ff ff ff ff       	mov    $0xffffffff,%edx
80106905:	31 c9                	xor    %ecx,%ecx
80106907:	66 89 90 10 28 11 80 	mov    %dx,-0x7feed7f0(%eax)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010690e:	c6 80 fc 27 11 80 00 	movb   $0x0,-0x7feed804(%eax)
  pd[0] = size-1;
80106915:	ba 2f 00 00 00       	mov    $0x2f,%edx
8010691a:	c6 80 fd 27 11 80 9a 	movb   $0x9a,-0x7feed803(%eax)
80106921:	c6 80 fe 27 11 80 cf 	movb   $0xcf,-0x7feed802(%eax)
80106928:	c6 80 ff 27 11 80 00 	movb   $0x0,-0x7feed801(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010692f:	c6 80 04 28 11 80 00 	movb   $0x0,-0x7feed7fc(%eax)
80106936:	c6 80 05 28 11 80 92 	movb   $0x92,-0x7feed7fb(%eax)
8010693d:	c6 80 06 28 11 80 cf 	movb   $0xcf,-0x7feed7fa(%eax)
80106944:	c6 80 07 28 11 80 00 	movb   $0x0,-0x7feed7f9(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010694b:	c6 80 0c 28 11 80 00 	movb   $0x0,-0x7feed7f4(%eax)
80106952:	c6 80 0d 28 11 80 fa 	movb   $0xfa,-0x7feed7f3(%eax)
80106959:	c6 80 0e 28 11 80 cf 	movb   $0xcf,-0x7feed7f2(%eax)
80106960:	c6 80 0f 28 11 80 00 	movb   $0x0,-0x7feed7f1(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106967:	66 89 88 12 28 11 80 	mov    %cx,-0x7feed7ee(%eax)
8010696e:	c6 80 14 28 11 80 00 	movb   $0x0,-0x7feed7ec(%eax)
80106975:	c6 80 15 28 11 80 f2 	movb   $0xf2,-0x7feed7eb(%eax)
8010697c:	c6 80 16 28 11 80 cf 	movb   $0xcf,-0x7feed7ea(%eax)
80106983:	c6 80 17 28 11 80 00 	movb   $0x0,-0x7feed7e9(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
8010698a:	05 f0 27 11 80       	add    $0x801127f0,%eax
8010698f:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  pd[1] = (uint)p;
80106993:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80106997:	c1 e8 10             	shr    $0x10,%eax
8010699a:	66 89 45 f6          	mov    %ax,-0xa(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
8010699e:	8d 45 f2             	lea    -0xe(%ebp),%eax
801069a1:	0f 01 10             	lgdtl  (%eax)
}
801069a4:	c9                   	leave  
801069a5:	c3                   	ret    
...
801069b0:	a1 a4 55 11 80       	mov    0x801155a4,%eax
{
...
801069e9:	0f 84 dc 00 00 00    	je     80106acb <switchuvm+0xfb>
  if(p->pgdir == 0)
801069ef:	8b 7e 04             	mov    0x4(%esi),%edi
801069f2:	85 ff                	test   %edi,%edi
801069f4:	0f 84 c4 00 00 00    	je     80106abe <switchuvm+0xee>
  pushcli();
801069fa:	e8 b1 d9 ff ff       	call   801043b0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801069ff:	e8 ec cc ff ff       	call   801036f0 <mycpu>
80106a04:	89 c3                	mov    %eax,%ebx
80106a06:	e8 e5 cc ff ff       	call   801036f0 <mycpu>
80106a0b:	89 c7                	mov    %eax,%edi
80106a0d:	e8 de cc ff ff       	call   801036f0 <mycpu>
80106a12:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106a15:	83 c7 08             	add    $0x8,%edi
80106a18:	e8 d3 cc ff ff       	call   801036f0 <mycpu>
...
80106a2b:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
80106a32:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80106a39:	c6 83 9d 00 00 00 99 	movb   $0x99,0x9d(%ebx)
80106a40:	c6 83 9e 00 00 00 40 	movb   $0x40,0x9e(%ebx)
80106a47:	83 c1 08             	add    $0x8,%ecx
80106a4a:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
80106a50:	c1 e9 10             	shr    $0x10,%ecx
80106a53:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106a59:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  mycpu()->gdt[SEG_TSS].s = 0;
80106a5e:	e8 8d cc ff ff       	call   801036f0 <mycpu>
80106a63:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106a6a:	e8 81 cc ff ff       	call   801036f0 <mycpu>
80106a6f:	b9 10 00 00 00       	mov    $0x10,%ecx
80106a74:	66 89 48 10          	mov    %cx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106a78:	e8 73 cc ff ff       	call   801036f0 <mycpu>
80106a7d:	8b 56 08             	mov    0x8(%esi),%edx
80106a80:	8d 8a 00 10 00 00    	lea    0x1000(%edx),%ecx
80106a86:	89 48 0c             	mov    %ecx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106a89:	e8 62 cc ff ff       	call   801036f0 <mycpu>
...
80106aa5:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106aa8:	5b                   	pop    %ebx
80106aa9:	5e                   	pop    %esi
80106aaa:	5f                   	pop    %edi
80106aab:	5d                   	pop    %ebp
  popcli();
80106aac:	e9 ef d9 ff ff       	jmp    801044a0 <popcli>
    panic("switchuvm: no process");
80106ab1:	83 ec 0c             	sub    $0xc,%esp
80106ab4:	68 32 79 10 80       	push   $0x80107932
80106ab9:	e8 b2 98 ff ff       	call   80100370 <panic>
    panic("switchuvm: no pgdir");
80106abe:	83 ec 0c             	sub    $0xc,%esp
80106ac1:	68 5d 79 10 80       	push   $0x8010795d
80106ac6:	e8 a5 98 ff ff       	call   80100370 <panic>
    panic("switchuvm: no kstack");
80106acb:	83 ec 0c             	sub    $0xc,%esp
80106ace:	68 48 79 10 80       	push   $0x80107948
80106ad3:	e8 98 98 ff ff       	call   80100370 <panic>
80106ad8:	90                   	nop
...
80106afb:	77 49                	ja     80106b46 <inituvm+0x66>
  mem = kalloc();
80106afd:	e8 8e b9 ff ff       	call   80102490 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106b0f:	e8 4c da ff ff       	call   80104560 <memset>
...
80106b29:	e8 52 fc ff ff       	call   80106780 <mappages>
  memmove(mem, init, sz);
...
80106b40:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106b41:	e9 ca da ff ff       	jmp    80104610 <memmove>
    panic("inituvm: more than a page");
80106b46:	83 ec 0c             	sub    $0xc,%esp
80106b49:	68 71 79 10 80       	push   $0x80107971
80106b4e:	e8 1d 98 ff ff       	call   80100370 <panic>
...
80106ba3:	e8 58 fb ff ff       	call   80106700 <walkpgdir>
...
80106bd1:	e8 7a ad ff ff       	call   80101950 <readi>
80106bd6:	83 c4 10             	add    $0x10,%esp
80106bd9:	39 c7                	cmp    %eax,%edi
...
80106bfd:	68 8b 79 10 80       	push   $0x8010798b
80106c02:	e8 69 97 ff ff       	call   80100370 <panic>
    panic("loaduvm: addr must be page aligned");
80106c07:	83 ec 0c             	sub    $0xc,%esp
80106c0a:	68 2c 7a 10 80       	push   $0x80107a2c
80106c0f:	e8 5c 97 ff ff       	call   80100370 <panic>
...
80106c2e:	78 7b                	js     80106cab <allocuvm+0x8b>
  if(newsz < oldsz)
80106c30:	3b 7d 0c             	cmp    0xc(%ebp),%edi
    return oldsz;
80106c33:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
80106c36:	72 75                	jb     80106cad <allocuvm+0x8d>
  a = PGROUNDUP(oldsz);
80106c38:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80106c3e:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
80106c44:	39 df                	cmp    %ebx,%edi
80106c46:	77 43                	ja     80106c8b <allocuvm+0x6b>
80106c48:	eb 6e                	jmp    80106cb8 <allocuvm+0x98>
...
80106c5b:	e8 00 d9 ff ff       	call   80104560 <memset>
...
80106c75:	e8 06 fb ff ff       	call   80106780 <mappages>
80106c7a:	83 c4 10             	add    $0x10,%esp
80106c7d:	85 c0                	test   %eax,%eax
80106c7f:	78 47                	js     80106cc8 <allocuvm+0xa8>
  for(; a < newsz; a += PGSIZE){
80106c81:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106c87:	39 df                	cmp    %ebx,%edi
80106c89:	76 2d                	jbe    80106cb8 <allocuvm+0x98>
    mem = kalloc();
80106c8b:	e8 00 b8 ff ff       	call   80102490 <kalloc>
    if(mem == 0){
80106c90:	85 c0                	test   %eax,%eax
    mem = kalloc();
80106c92:	89 c6                	mov    %eax,%esi
    if(mem == 0){
80106c94:	75 ba                	jne    80106c50 <allocuvm+0x30>
      cprintf("allocuvm out of memory\n");
80106c96:	83 ec 0c             	sub    $0xc,%esp
80106c99:	68 a9 79 10 80       	push   $0x801079a9
80106c9e:	e8 bd 99 ff ff       	call   80100660 <cprintf>
  if(newsz >= oldsz)
80106ca3:	83 c4 10             	add    $0x10,%esp
80106ca6:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106ca9:	77 4f                	ja     80106cfa <allocuvm+0xda>
      return 0;
...
80106ccb:	68 c1 79 10 80       	push   $0x801079c1
80106cd0:	e8 8b 99 ff ff       	call   80100660 <cprintf>
  if(newsz >= oldsz)
80106cd5:	83 c4 10             	add    $0x10,%esp
80106cd8:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106cdb:	76 0d                	jbe    80106cea <allocuvm+0xca>
80106cdd:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106ce0:	8b 45 08             	mov    0x8(%ebp),%eax
80106ce3:	89 fa                	mov    %edi,%edx
80106ce5:	e8 26 fb ff ff       	call   80106810 <deallocuvm.part.0>
      kfree(mem);
80106cea:	83 ec 0c             	sub    $0xc,%esp
80106ced:	56                   	push   %esi
80106cee:	e8 ed b5 ff ff       	call   801022e0 <kfree>
      return 0;
80106cf3:	83 c4 10             	add    $0x10,%esp
80106cf6:	31 c0                	xor    %eax,%eax
80106cf8:	eb b3                	jmp    80106cad <allocuvm+0x8d>
80106cfa:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106cfd:	8b 45 08             	mov    0x8(%ebp),%eax
80106d00:	89 fa                	mov    %edi,%edx
80106d02:	e8 09 fb ff ff       	call   80106810 <deallocuvm.part.0>
      return 0;
80106d07:	31 c0                	xor    %eax,%eax
80106d09:	eb a2                	jmp    80106cad <allocuvm+0x8d>
80106d0b:	90                   	nop
...
80106d20:	5d                   	pop    %ebp
80106d21:	e9 ea fa ff ff       	jmp    80106810 <deallocuvm.part.0>
...
80106d59:	e8 b2 fa ff ff       	call   80106810 <deallocuvm.part.0>
...
80106de0:	e8 7b d7 ff ff       	call   80104560 <memset>
...
80106dfb:	e8 80 f9 ff ff       	call   80106780 <mappages>
...
80106e10:	72 d6                	jb     80106de8 <setupkvm+0x28>
}
...
80106e6e:	e8 8d f8 ff ff       	call   80106700 <walkpgdir>
  if(pte == 0)
...
80106ed3:	e8 38 d7 ff ff       	call   80104610 <memmove>
...
80106eef:	e8 8c f8 ff ff       	call   80106780 <mappages>
...
80106f0d:	e8 ee f7 ff ff       	call   80106700 <walkpgdir>
...
80106f5c:	e8 0f 94 ff ff       	call   80100370 <panic>
      panic("copyuvm: page not present");
80106f61:	83 ec 0c             	sub    $0xc,%esp
80106f64:	68 12 7a 10 80       	push   $0x80107a12
80106f69:	e8 02 94 ff ff       	call   80100370 <panic>
...
80106f7e:	e8 7d f7 ff ff       	call   80106700 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106fef:	e8 1c d6 ff ff       	call   80104610 <memmove>
    len -= n;
    buf += n;
