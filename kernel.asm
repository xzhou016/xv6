...
80100193:	68 ae 6e 10 80       	push   $0x80106eae
...
801001cc:	68 bf 6e 10 80       	push   $0x80106ebf
...
80100264:	68 c6 6e 10 80       	push   $0x80106ec6
...
80100392:	68 cd 6e 10 80       	push   $0x80106ecd
...
801003a0:	e8 bb 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003a5:	c7 04 24 17 78 10 80 	movl   $0x80107817,(%esp)
...
801003c8:	68 e1 6e 10 80       	push   $0x80106ee1
...
80100519:	e8 c2 3f 00 00       	call   801044e0 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
8010052e:	e8 fd 3e 00 00       	call   80104430 <memset>
80100533:	89 f9                	mov    %edi,%ecx
80100535:	83 c4 10             	add    $0x10,%esp
80100538:	e9 5c ff ff ff       	jmp    80100499 <consputc+0xa9>
    panic("pos under/overflow");
8010053d:	83 ec 0c             	sub    $0xc,%esp
80100540:	68 e5 6e 10 80       	push   $0x80106ee5
...
801005a9:	0f b6 92 10 6f 10 80 	movzbl -0x7fef90f0(%edx),%edx
  }while((x /= base) != 0);
...
80100705:	e8 d6 3c 00 00       	call   801043e0 <release>
...
801007b8:	b8 28 00 00 00       	mov    $0x28,%eax
        s = "(null)";
801007bd:	bf f8 6e 10 80       	mov    $0x80106ef8,%edi
801007c2:	eb bc                	jmp    80100780 <cprintf+0x120>
    panic("null fmt");
801007c4:	83 ec 0c             	sub    $0xc,%esp
801007c7:	68 ff 6e 10 80       	push   $0x80106eff
...
80100858:	e8 83 3b 00 00       	call   801043e0 <release>
  if(doprocdump) {
...
80100996:	68 08 6f 10 80       	push   $0x80106f08
8010099b:	68 20 a5 10 80       	push   $0x8010a520
801009a0:	e8 1b 38 00 00       	call   801041c0 <initlock>
...
80100a62:	75 d2                	jne    80100a36 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100a64:	e8 97 61 00 00       	call   80106c00 <setupkvm>
...
80100af4:	e8 67 5f 00 00       	call   80106a60 <allocuvm>
...
80100b2a:	e8 71 5e 00 00       	call   801069a0 <loaduvm>
...
80100b49:	e8 32 60 00 00       	call   80106b80 <freevm>
...
80100b85:	e8 d6 5e 00 00       	call   80106a60 <allocuvm>
...
80100b9c:	e8 df 5f 00 00       	call   80106b80 <freevm>
...
80100bb6:	68 21 6f 10 80       	push   $0x80106f21
...
80100be1:	e8 ba 60 00 00       	call   80106ca0 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100c1d:	e8 2e 3a 00 00       	call   80104650 <strlen>
...
80100c30:	e8 1b 3a 00 00       	call   80104650 <strlen>
...
80100c41:	e8 aa 61 00 00       	call   80106df0 <copyout>
...
80100ca5:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100cab:	e8 40 61 00 00       	call   80106df0 <copyout>
...
80100cf0:	e8 1b 39 00 00       	call   80104610 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100d1c:	e8 ef 5a 00 00       	call   80106810 <switchuvm>
  freevm(oldpgdir);
80100d21:	89 3c 24             	mov    %edi,(%esp)
80100d24:	e8 57 5e 00 00       	call   80106b80 <freevm>
  return 0;
...
80100d46:	68 2d 6f 10 80       	push   $0x80106f2d
80100d4b:	68 c0 ff 10 80       	push   $0x8010ffc0
80100d50:	e8 6b 34 00 00       	call   801041c0 <initlock>
}
...
80100d71:	e8 4a 35 00 00       	call   801042c0 <acquire>
...
80100da1:	e8 3a 36 00 00       	call   801043e0 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100dba:	e8 21 36 00 00       	call   801043e0 <release>
}
...
80100ddf:	e8 dc 34 00 00       	call   801042c0 <acquire>
  if(f->ref < 1)
...
80100dfc:	e8 df 35 00 00       	call   801043e0 <release>
  return f;
}
...
80100e0b:	68 34 6f 10 80       	push   $0x80106f34
...
80100e31:	e8 8a 34 00 00       	call   801042c0 <acquire>
  if(f->ref < 1)
...
80100e5b:	5d                   	pop    %ebp
    release(&ftable.lock);
80100e5c:	e9 7f 35 00 00       	jmp    801043e0 <release>
...
80100e85:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100e88:	e8 53 35 00 00       	call   801043e0 <release>
  if(ff.type == FD_PIPE)
...
80100ee2:	68 3c 6f 10 80       	push   $0x80106f3c
...
80100fc2:	68 46 6f 10 80       	push   $0x80106f46
...
801010e0:	68 4f 6f 10 80       	push   $0x80106f4f
801010e5:	e8 86 f2 ff ff       	call   80100370 <panic>
  panic("filewrite");
801010ea:	83 ec 0c             	sub    $0xc,%esp
801010ed:	68 55 6f 10 80       	push   $0x80106f55
...
801011a4:	68 5f 6f 10 80       	push   $0x80106f5f
...
801012d4:	68 75 6f 10 80       	push   $0x80106f75
...
801013a5:	68 85 6f 10 80       	push   $0x80106f85
...
80101464:	68 98 6f 10 80       	push   $0x80106f98
...
8010147c:	68 ab 6f 10 80       	push   $0x80106fab
...
80101493:	68 b2 6f 10 80       	push   $0x80106fb2
...
801014e9:	68 18 70 10 80       	push   $0x80107018
...
801015b3:	68 b8 6f 10 80       	push   $0x80106fb8
...
8010172d:	68 d0 6f 10 80       	push   $0x80106fd0
80101732:	e8 39 ec ff ff       	call   80100370 <panic>
    panic("ilock");
80101737:	83 ec 0c             	sub    $0xc,%esp
8010173a:	68 ca 6f 10 80       	push   $0x80106fca
...
80101787:	68 df 6f 10 80       	push   $0x80106fdf
...
801019f5:	01 de                	add    %ebx,%esi
    memmove(dst, bp->data + off%BSIZE, m);
801019f7:	e8 e4 2a 00 00       	call   801044e0 <memmove>
    brelse(bp);
...
80101af3:	e8 e8 29 00 00       	call   801044e0 <memmove>
    log_write(bp);
...
80101c2d:	68 f9 6f 10 80       	push   $0x80106ff9
80101c32:	e8 39 e7 ff ff       	call   80100370 <panic>
    panic("dirlookup not DIR");
80101c37:	83 ec 0c             	sub    $0xc,%esp
80101c3a:	68 e7 6f 10 80       	push   $0x80106fe7
...
80101e9b:	68 08 70 10 80       	push   $0x80107008
80101ea0:	e8 cb e4 ff ff       	call   80100370 <panic>
    panic("dirlink");
80101ea5:	83 ec 0c             	sub    $0xc,%esp
80101ea8:	68 fe 75 10 80       	push   $0x801075fe
...
80101fb0:	68 74 70 10 80       	push   $0x80107074
80101fb5:	e8 b6 e3 ff ff       	call   80100370 <panic>
    panic("idestart");
80101fba:	83 ec 0c             	sub    $0xc,%esp
80101fbd:	68 6b 70 10 80       	push   $0x8010706b
...
80101fd6:	68 86 70 10 80       	push   $0x80107086
...
801021be:	68 8a 70 10 80       	push   $0x8010708a
801021c3:	e8 a8 e1 ff ff       	call   80100370 <panic>
    panic("iderw: ide disk 1 not present");
801021c8:	83 ec 0c             	sub    $0xc,%esp
801021cb:	68 b5 70 10 80       	push   $0x801070b5
801021d0:	e8 9b e1 ff ff       	call   80100370 <panic>
    panic("iderw: nothing to do");
801021d5:	83 ec 0c             	sub    $0xc,%esp
801021d8:	68 a0 70 10 80       	push   $0x801070a0
...
8010223a:	68 d4 70 10 80       	push   $0x801070d4
...
80102365:	68 06 71 10 80       	push   $0x80107106
...
801023cb:	68 0c 71 10 80       	push   $0x8010710c
...
8010253f:	0f b6 8a 40 72 10 80 	movzbl -0x7fef8dc0(%edx),%ecx
...
8010255c:	83 e1 08             	and    $0x8,%ecx
  c = charcode[shift & (CTL | SHIFT)][data];
8010255f:	8b 04 85 20 71 10 80 	mov    -0x7fef8ee0(,%eax,4),%eax
...
8010258c:	0f 44 d0             	cmove  %eax,%edx
    shift &= ~(shiftcode[data] | E0ESC);
8010258f:	0f b6 82 40 72 10 80 	movzbl -0x7fef8dc0(%edx),%eax
...
80102907:	e8 74 1b 00 00       	call   80104480 <memcmp>
...
80102ada:	68 40 73 10 80       	push   $0x80107340
...
80102c2c:	e8 af 17 00 00       	call   801043e0 <release>
}
...
80102d37:	68 44 73 10 80       	push   $0x80107344
...
80102ddc:	c9                   	leave  
  release(&log.lock);
80102ddd:	e9 fe 15 00 00       	jmp    801043e0 <release>
...
80102e03:	68 53 73 10 80       	push   $0x80107353
80102e08:	e8 63 d5 ff ff       	call   80100370 <panic>
    panic("log_write outside of trans");
80102e0d:	83 ec 0c             	sub    $0xc,%esp
80102e10:	68 69 73 10 80       	push   $0x80107369
...
80102e38:	68 84 73 10 80       	push   $0x80107384
80102e3d:	e8 1e d8 ff ff       	call   80100660 <cprintf>
  idtinit();       // load idt register
80102e42:	e8 89 28 00 00       	call   801056d0 <idtinit>
...
80102e63:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e66:	e8 85 39 00 00       	call   801067f0 <switchkvm>
  seginit();
80102e6b:	e8 80 38 00 00       	call   801066f0 <seginit>
  lapicinit();
...
80102ec9:	e8 f2 2a 00 00       	call   801059c0 <uartinit>
  pinit();         // process table
80102ece:	e8 fd 07 00 00       	call   801036d0 <pinit>
  tvinit();        // trap vectors
80102ed3:	e8 58 27 00 00       	call   80105630 <tvinit>
  binit();         // buffer cache
...
80102fc8:	68 98 73 10 80       	push   $0x80107398
...
8010307c:	68 b5 73 10 80       	push   $0x801073b5
80103081:	56                   	push   %esi
80103082:	e8 f9 13 00 00       	call   80104480 <memcmp>
...
80103110:	ff 24 95 dc 73 10 80 	jmp    *-0x7fef8c24(,%edx,4)
...
801031b7:	68 9d 73 10 80       	push   $0x8010739d
801031bc:	e8 af d1 ff ff       	call   80100370 <panic>
    panic("Didn't find a suitable machine");
801031c1:	83 ec 0c             	sub    $0xc,%esp
801031c4:	68 bc 73 10 80       	push   $0x801073bc
...
80103270:	00 00 00 
  initlock(&p->lock, "pipe");
80103273:	68 f0 73 10 80       	push   $0x801073f0
80103278:	50                   	push   %eax
80103279:	e8 42 0f 00 00       	call   801041c0 <initlock>
  (*f0)->type = FD_PIPE;
...
8010330f:	e8 ac 0f 00 00       	call   801042c0 <acquire>
  if(writable){
...
80103353:	5d                   	pop    %ebp
    release(&p->lock);
80103354:	e9 87 10 00 00       	jmp    801043e0 <release>
...
80103384:	e8 57 10 00 00       	call   801043e0 <release>
    kfree((char*)p);
...
801033ad:	e8 0e 0f 00 00       	call   801042c0 <acquire>
  for(i = 0; i < n; i++){
...
8010349c:	e8 3f 0f 00 00       	call   801043e0 <release>
  return n;
...
8010352e:	e8 ad 0e 00 00       	call   801043e0 <release>
      return -1;
...
8010358f:	e8 4c 0e 00 00       	call   801043e0 <release>
  return i;
...
8010365a:	e8 81 0d 00 00       	call   801043e0 <release>
}
...
8010368b:	e8 50 0d 00 00       	call   801043e0 <release>
...
801036d6:	68 f5 73 10 80       	push   $0x801073f5
801036db:	68 20 2d 11 80       	push   $0x80112d20
801036e0:	e8 db 0a 00 00       	call   801041c0 <initlock>
}
...
80103750:	68 fc 73 10 80       	push   $0x801073fc
80103755:	e8 16 cc ff ff       	call   80100370 <panic>
    panic("mycpu called with interrupts enabled\n");
8010375a:	83 ec 0c             	sub    $0xc,%esp
8010375d:	68 d8 74 10 80       	push   $0x801074d8
...
80103794:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103797:	e8 e4 0a 00 00       	call   80104280 <pushcli>
  c = mycpu();
8010379c:	e8 4f ff ff ff       	call   801036f0 <mycpu>
  p = c->proc;
801037a1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801037a7:	e8 c4 0b 00 00       	call   80104370 <popcli>
}
...
801037d3:	e8 28 34 00 00       	call   80106c00 <setupkvm>
...
801037f1:	e8 2a 31 00 00       	call   80106920 <inituvm>
...
80103806:	e8 25 0c 00 00       	call   80104430 <memset>
...
8010385f:	68 25 74 10 80       	push   $0x80107425
80103864:	50                   	push   %eax
80103865:	e8 a6 0d 00 00       	call   80104610 <safestrcpy>
  p->cwd = namei("/");
8010386a:	c7 04 24 2e 74 10 80 	movl   $0x8010742e,(%esp)
...
801038a3:	68 0c 74 10 80       	push   $0x8010740c
...
801038b5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
801038b8:	e8 c3 09 00 00       	call   80104280 <pushcli>
  c = mycpu();
801038bd:	e8 2e fe ff ff       	call   801036f0 <mycpu>
  p = c->proc;
801038c2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801038c8:	e8 a3 0a 00 00       	call   80104370 <popcli>
  if(n > 0){
...
801038de:	e8 7d 31 00 00       	call   80106a60 <allocuvm>
...
801038f0:	e8 1b 2f 00 00       	call   80106810 <switchuvm>
  return 0;
...
80103936:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103939:	e8 42 09 00 00       	call   80104280 <pushcli>
  c = mycpu();
8010393e:	e8 ad fd ff ff       	call   801036f0 <mycpu>
  p = c->proc;
80103943:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103949:	e8 22 0a 00 00       	call   80104370 <popcli>
  if((np = allocproc()) == 0){
...
80103968:	e8 63 33 00 00       	call   80106cd0 <copyuvm>
...
80103a7e:	e8 3d 08 00 00       	call   801042c0 <acquire>
...
80103aab:	83 c3 7c             	add    $0x7c,%ebx
      switchuvm(p);
80103aae:	e8 5d 2d 00 00       	call   80106810 <switchuvm>
...
80103ab9:	c7 43 90 04 00 00 00 	movl   $0x4,-0x70(%ebx)
      swtch(&(c->scheduler), p->context);
80103ac0:	e8 a6 0b 00 00       	call   8010466b <swtch>
      switchkvm();
80103ac5:	e8 26 2d 00 00       	call   801067f0 <switchkvm>
      c->proc = 0;
...
80103ae8:	e8 f3 08 00 00       	call   801043e0 <release>
    sti();
...
80103b04:	53                   	push   %ebx
  pushcli();
80103b05:	e8 76 07 00 00       	call   80104280 <pushcli>
  c = mycpu();
...
80103b22:	e8 19 07 00 00       	call   80104240 <holding>
...
80103b63:	e8 03 0b 00 00       	call   8010466b <swtch>
  mycpu()->intena = intena;
...
80103bc6:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103bc9:	e8 b2 06 00 00       	call   80104280 <pushcli>
  c = mycpu();
...
80103c32:	e8 89 06 00 00       	call   801042c0 <acquire>
...
80103ccd:	68 7d 74 10 80       	push   $0x8010747d
80103cd2:	e8 99 c6 ff ff       	call   80100370 <panic>
    panic("init exiting");
80103cd7:	83 ec 0c             	sub    $0xc,%esp
80103cda:	68 70 74 10 80       	push   $0x80107470
...
80103cfc:	e8 bf 05 00 00       	call   801042c0 <acquire>
  pushcli();
80103d01:	e8 7a 05 00 00       	call   80104280 <pushcli>
  c = mycpu();
...
80103d29:	e8 b2 06 00 00       	call   801043e0 <release>
}
...
80103d4c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103d4f:	e8 2c 05 00 00       	call   80104280 <pushcli>
  c = mycpu();
...
80103d80:	e8 3b 05 00 00       	call   801042c0 <acquire>
    release(lk);
80103d85:	89 34 24             	mov    %esi,(%esp)
80103d88:	e8 53 06 00 00       	call   801043e0 <release>
  p->chan = chan;
...
80103daa:	e8 31 06 00 00       	call   801043e0 <release>
    acquire(lk);
...
80103dbb:	5d                   	pop    %ebp
    acquire(lk);
80103dbc:	e9 ff 04 00 00       	jmp    801042c0 <acquire>
...
80103de9:	68 8f 74 10 80       	push   $0x8010748f
80103dee:	e8 7d c5 ff ff       	call   80100370 <panic>
    panic("sleep");
80103df3:	83 ec 0c             	sub    $0xc,%esp
80103df6:	68 89 74 10 80       	push   $0x80107489
...
80103e04:	53                   	push   %ebx
  pushcli();
80103e05:	e8 76 04 00 00       	call   80104280 <pushcli>
  c = mycpu();
...
80103e22:	e8 99 04 00 00       	call   801042c0 <acquire>
...
80103ec3:	e8 18 05 00 00       	call   801043e0 <release>
        return pid;
...
80103ee1:	e8 fa 04 00 00       	call   801043e0 <release>
      return -1;
...
8010400b:	68 17 78 10 80       	push   $0x80107817
...
8010402e:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104031:	ba a0 74 10 80       	mov    $0x801074a0,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104036:	77 11                	ja     80104049 <procdump+0x59>
80104038:	8b 14 85 00 75 10 80 	mov    -0x7fef8b00(,%eax,4),%edx
      state = "???";
8010403f:	b8 a0 74 10 80       	mov    $0x801074a0,%eax
...
80104051:	68 a4 74 10 80       	push   $0x801074a4
...
80104078:	e8 63 01 00 00       	call   801041e0 <getcallerpcs>
...
8010408d:	68 e1 6e 10 80       	push   $0x80106ee1
...
801040ba:	68 18 75 10 80       	push   $0x80107518
...
80104263:	e8 88 f4 ff ff       	call   801036f0 <mycpu>
...
8010429f:	e8 4c f4 ff ff       	call   801036f0 <mycpu>
...
801042f4:	e8 f7 f3 ff ff       	call   801036f0 <mycpu>
  ebp = (uint*)v - 2;
...
8010437b:	75 52                	jne    801043cf <popcli+0x5f>
  ...
  if(--mycpu()->ncli < 0)
8010437d:	e8 6e f3 ff ff       	call   801036f0 <mycpu>
...
80104395:	e8 56 f3 ff ff       	call   801036f0 <mycpu>
...
801043a9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  if(mycpu()->ncli == 0 && mycpu()->intena)
801043b0:	e8 3b f3 ff ff       	call   801036f0 <mycpu>
...
801043c5:	68 42 75 10 80       	push   $0x80107542
801043ca:	e8 a1 bf ff ff       	call   80100370 <panic>
    panic("popcli - interruptible");
801043cf:	83 ec 0c             	sub    $0xc,%esp
801043d2:	68 2b 75 10 80       	push   $0x8010752b
...
801043f1:	68 49 75 10 80       	push   $0x80107549
...
801044f2:	8d 14 33             	lea    (%ebx,%esi,1),%edx
801044f5:	39 d0                	cmp    %edx,%eax
...
80104563:	0f b6 11             	movzbl (%ecx),%edx
...
8010457f:	0f b6 18             	movzbl (%eax),%ebx
80104582:	89 c6                	mov    %eax,%esi
80104584:	38 da                	cmp    %bl,%dl
80104586:	75 1c                	jne    801045a4 <strncmp+0x54>
    n--, p++, q++;
80104588:	8d 46 01             	lea    0x1(%esi),%eax
8010458b:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
8010458e:	39 f8                	cmp    %edi,%eax
...
801045a0:	0f b6 5e 01          	movzbl 0x1(%esi),%ebx
  return (uchar)*p - (uchar)*q;
801045a4:	0f b6 c2             	movzbl %dl,%eax
801045a7:	29 d8                	sub    %ebx,%eax
}
801045a9:	5b                   	pop    %ebx
801045aa:	5e                   	pop    %esi
801045ab:	5f                   	pop    %edi
...
80104687:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010468a:	e8 01 f1 ff ff       	call   80103790 <myproc>
...
801046c7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
801046ca:	e8 c1 f0 ff ff       	call   80103790 <myproc>
...
80104814:	53                   	push   %ebx
  int num;
  struct proc *curproc = myproc();
80104815:	e8 76 ef ff ff       	call   80103790 <myproc>
...
8010482a:	8b 14 85 80 75 10 80 	mov    -0x7fef8a80(,%eax,4),%edx
...
80104850:	68 51 75 10 80       	push   $0x80107551
...
80104876:	8d 5d da             	lea    -0x26(%ebp),%ebx
{
...
801048d7:	66 83 7f 50 02       	cmpw   $0x2,0x50(%edi)
...
801048f4:	31 ff                	xor    %edi,%edi
    iunlockput(ip);
801048f6:	e8 05 d0 ff ff       	call   80101900 <iunlockput>
    return 0;
...
80104939:	66 89 47 52          	mov    %ax,0x52(%edi)
  ip->minor = minor;
8010493d:	0f b7 45 bc          	movzwl -0x44(%ebp),%eax
80104941:	66 89 47 54          	mov    %ax,0x54(%edi)
  ip->nlink = 1;
80104945:	b8 01 00 00 00       	mov    $0x1,%eax
8010494a:	66 89 47 56          	mov    %ax,0x56(%edi)
  iupdate(ip);
8010494e:	89 3c 24             	mov    %edi,(%esp)
...
80104963:	ff 77 04             	pushl  0x4(%edi)
...
80104999:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    dp->nlink++;  // for ".."
801049a0:	66 83 46 56 01       	addw   $0x1,0x56(%esi)
    iupdate(dp);
...
801049b4:	68 f4 75 10 80       	push   $0x801075f4
...
801049c9:	ff 76 04             	pushl  0x4(%esi)
801049cc:	68 f3 75 10 80       	push   $0x801075f3
...
80104a98:	8b 75 f4             	mov    -0xc(%ebp),%esi
  struct proc *curproc = myproc();
80104a9b:	e8 f0 ec ff ff       	call   80103790 <myproc>
...
80104ab0:	8d 65 f8             	lea    -0x8(%ebp),%esp
    return -1;
80104ab3:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
}
...
80104aca:	e8 01 c3 ff ff       	call   80100dd0 <filedup>
  return fd;
...
80104b2d:	e8 0e c4 ff ff       	call   80100f40 <fileread>
...
80104b9d:	e8 2e c4 ff ff       	call   80100fd0 <filewrite>
...
80104bd3:	78 2b                	js     80104c00 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104bd5:	e8 b6 eb ff ff       	call   80103790 <myproc>
...
80104beb:	e8 30 c2 ff ff       	call   80100e20 <fileclose>
  return 0;
...
80104c44:	e8 a7 c2 ff ff       	call   80100ef0 <filestat>
...
80104c92:	0f 88 e2 00 00 00    	js     80104d7a <sys_link+0x11a>
  begin_op();
80104c98:	e8 d3 de ff ff       	call   80102b70 <begin_op>
  if((ip = namei(old)) == 0){
...
80104d2b:	e8 70 ca ff ff       	call   801017a0 <iput>
  end_op();
80104d30:	e8 ab de ff ff       	call   80102be0 <end_op>
  return 0;
...
80104d6d:	e8 8e cb ff ff       	call   80101900 <iunlockput>
  end_op();
80104d72:	e8 69 de ff ff       	call   80102be0 <end_op>
  return -1;
...
80104ddf:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  begin_op();
80104de2:	e8 89 dd ff ff       	call   80102b70 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
80104e0d:	58                   	pop    %eax
80104e0e:	5a                   	pop    %edx
80104e0f:	68 f4 75 10 80       	push   $0x801075f4
...
80104e28:	68 f3 75 10 80       	push   $0x801075f3
...
80104e82:	e8 a9 f5 ff ff       	call   80104430 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80104ec7:	e8 34 ca ff ff       	call   80101900 <iunlockput>
  end_op();
80104ecc:	e8 0f dd ff ff       	call   80102be0 <end_op>
  return 0;
...
80104f27:	e8 d4 c9 ff ff       	call   80101900 <iunlockput>
  end_op();
80104f2c:	e8 af dc ff ff       	call   80102be0 <end_op>
  return -1;
...
80104f66:	e9 6b ff ff ff       	jmp    80104ed6 <sys_unlink+0x116>
    end_op();
80104f6b:	e8 70 dc ff ff       	call   80102be0 <end_op>
    return -1;
...
80104fe2:	0f 88 85 00 00 00    	js     8010506d <sys_open+0xbd>
  ...
  begin_op();
80104fe8:	e8 83 db ff ff       	call   80102b70 <begin_op>
...
80105026:	e8 35 bd ff ff       	call   80100d60 <filealloc>
...
80105031:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105033:	e8 58 e7 ff ff       	call   80103790 <myproc>
80105038:	90                   	nop
...
80105054:	e8 c7 bd ff ff       	call   80100e20 <fileclose>
...
8010509b:	75 89                	jne    80105026 <sys_open+0x76>
      end_op();
8010509d:	e8 3e db ff ff       	call   80102be0 <end_op>
      return -1;
801050a2:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801050a7:	eb 40                	jmp    801050e9 <sys_open+0x139>
...
801050d1:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
  f->readable = !(omode & O_WRONLY);
801050d8:	89 c2                	mov    %eax,%edx
801050da:	f7 d2                	not    %edx
801050dc:	88 57 08             	mov    %dl,0x8(%edi)
801050df:	80 67 08 01          	andb   $0x1,0x8(%edi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801050e3:	a8 03                	test   $0x3,%al
801050e5:	0f 95 47 09          	setne  0x9(%edi)
}
801050e9:	8d 65 f4             	lea    -0xc(%ebp),%esp
801050ec:	89 d8                	mov    %ebx,%eax
801050ee:	5b                   	pop    %ebx
801050ef:	5e                   	pop    %esi
801050f0:	5f                   	pop    %edi
801050f1:	5d                   	pop    %ebp
...
80105113:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105116:	e8 55 da ff ff       	call   80102b70 <begin_op>
...
8010514f:	e8 ac c7 ff ff       	call   80101900 <iunlockput>
  end_op();
80105154:	e8 87 da ff ff       	call   80102be0 <end_op>
  return 0;
...
8010515f:	c3                   	ret    
    end_op();
80105160:	e8 7b da ff ff       	call   80102be0 <end_op>
    return -1;
...
80105173:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105176:	e8 f5 d9 ff ff       	call   80102b70 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
801051de:	e8 1d c7 ff ff       	call   80101900 <iunlockput>
  end_op();
801051e3:	e8 f8 d9 ff ff       	call   80102be0 <end_op>
  return 0;
...
80105205:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105208:	e8 83 e5 ff ff       	call   80103790 <myproc>
8010520d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010520f:	e8 5c d9 ff ff       	call   80102b70 <begin_op>
...
8010525d:	e8 3e c5 ff ff       	call   801017a0 <iput>
  end_op();
80105262:	e8 79 d9 ff ff       	call   80102be0 <end_op>
  curproc->cwd = ip;
...
80105284:	e8 77 c6 ff ff       	call   80101900 <iunlockput>
    end_op();
80105289:	e8 52 d9 ff ff       	call   80102be0 <end_op>
    return -1;
...
80105299:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    end_op();
801052a0:	e8 3b d9 ff ff       	call   80102be0 <end_op>
    return -1;
...
80105308:	e8 23 f1 ff ff       	call   80104430 <memset>
...
8010537b:	e8 60 b6 ff ff       	call   801009e0 <exec>
...
801053b8:	e8 43 de ff ff       	call   80103200 <pipealloc>
...
801053c6:	8b 7d e0             	mov    -0x20(%ebp),%edi
  struct proc *curproc = myproc();
801053c9:	e8 c2 e3 ff ff       	call   80103790 <myproc>
...
801053e6:	e8 35 ba ff ff       	call   80100e20 <fileclose>
    fileclose(wf);
801053eb:	58                   	pop    %eax
801053ec:	ff 75 e4             	pushl  -0x1c(%ebp)
801053ef:	e8 2c ba ff ff       	call   80100e20 <fileclose>
    return -1;
...
8010540f:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
80105412:	e8 79 e3 ff ff       	call   80103790 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
8010542e:	75 f0                	jne    80105420 <sys_pipe+0x90>
      myproc()->ofile[fd0] = 0;
80105430:	e8 5b e3 ff ff       	call   80103790 <myproc>
...
80105463:	5d                   	pop    %ebp
  return fork();
80105464:	e9 c7 e4 ff ff       	jmp    80103930 <fork>
...
80105473:	83 ec 08             	sub    $0x8,%esp
  exit();
80105476:	e8 45 e7 ff ff       	call   80103bc0 <exit>
...
80105483:	5d                   	pop    %ebp
  return wait();
80105484:	e9 77 e9 ff ff       	jmp    80103e00 <wait>
...
801054ae:	e8 ad ea ff ff       	call   80103f60 <kill>
...
801054d3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801054d6:	e8 b5 e2 ff ff       	call   80103790 <myproc>
...
80105506:	e8 a5 e3 ff ff       	call   801038b0 <growproc>
...
80105555:	e8 66 ed ff ff       	call   801042c0 <acquire>
  ticks0 = ticks;
...
8010557d:	e8 be e7 ff ff       	call   80103d40 <sleep>
  while(ticks - ticks0 < n){
...
8010558f:	73 2f                	jae    801055c0 <sys_sleep+0x90>
    if(myproc()->killed){
80105591:	e8 fa e1 ff ff       	call   80103790 <myproc>
...
801055ec:	e8 cf ec ff ff       	call   801042c0 <acquire>
  xticks = ticks;
...
80105640:	8b 14 85 08 a0 10 80 	mov    -0x7fef5ff8(,%eax,4),%edx
80105647:	b9 08 00 00 00       	mov    $0x8,%ecx
8010564c:	c6 04 c5 a4 4c 11 80 	movb   $0x0,-0x7feeb35c(,%eax,8)
80105653:	00 
80105654:	66 89 0c c5 a2 4c 11 	mov    %cx,-0x7feeb35e(,%eax,8)
8010565b:	80 
8010565c:	c6 04 c5 a5 4c 11 80 	movb   $0x8e,-0x7feeb35b(,%eax,8)
80105663:	8e 
80105664:	66 89 14 c5 a0 4c 11 	mov    %dx,-0x7feeb360(,%eax,8)
8010566b:	80 
8010566c:	c1 ea 10             	shr    $0x10,%edx
8010566f:	66 89 14 c5 a6 4c 11 	mov    %dx,-0x7feeb35a(,%eax,8)
80105676:	80 
  for(i = 0; i < 256; i++)
80105677:	83 c0 01             	add    $0x1,%eax
8010567a:	3d 00 01 00 00       	cmp    $0x100,%eax
8010567f:	75 bf                	jne    80105640 <tvinit+0x10>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105681:	a1 08 a1 10 80       	mov    0x8010a108,%eax

  initlock(&tickslock, "time");
80105686:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105689:	ba 08 00 00 00       	mov    $0x8,%edx
  initlock(&tickslock, "time");
8010568e:	68 39 76 10 80       	push   $0x80107639
80105693:	68 60 4c 11 80       	push   $0x80114c60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105698:	66 89 15 a2 4e 11 80 	mov    %dx,0x80114ea2
8010569f:	c6 05 a4 4e 11 80 00 	movb   $0x0,0x80114ea4
801056a6:	66 a3 a0 4e 11 80    	mov    %ax,0x80114ea0
801056ac:	c1 e8 10             	shr    $0x10,%eax
801056af:	c6 05 a5 4e 11 80 ef 	movb   $0xef,0x80114ea5
801056b6:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6
  initlock(&tickslock, "time");
801056bc:	e8 ff ea ff ff       	call   801041c0 <initlock>
}
...
80105720:	ff 24 85 e0 76 10 80 	jmp    *-0x7fef8920(,%eax,4)
...
80105730:	e8 5b e0 ff ff       	call   80103790 <myproc>
...
80105753:	e8 18 e0 ff ff       	call   80103770 <cpuid>
...
80105769:	e8 22 e0 ff ff       	call   80103790 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105785:	68 9c 76 10 80       	push   $0x8010769c
8010578a:	e8 d1 ae ff ff       	call   80100660 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
8010578f:	83 c4 20             	add    $0x20,%esp
80105792:	e8 f9 df ff ff       	call   80103790 <myproc>
...
801057a9:	e8 e2 df ff ff       	call   80103790 <myproc>
...
801057b5:	e8 d6 df ff ff       	call   80103790 <myproc>
801057ba:	85 c0                	test   %eax,%eax
801057bc:	74 0b                	je     801057c9 <trap+0xc9>
801057be:	e8 cd df ff ff       	call   80103790 <myproc>
...
801057c7:	74 4f                	je     80105818 <trap+0x118>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801057c9:	e8 c2 df ff ff       	call   80103790 <myproc>
801057ce:	85 c0                	test   %eax,%eax
801057d0:	74 1d                	je     801057ef <trap+0xef>
801057d2:	e8 b9 df ff ff       	call   80103790 <myproc>
...
8010580b:	75 a8                	jne    801057b5 <trap+0xb5>
    exit();
8010580d:	e8 ae e3 ff ff       	call   80103bc0 <exit>
...
8010581c:	75 ab                	jne    801057c9 <trap+0xc9>
    yield();
8010581e:	e8 cd e4 ff ff       	call   80103cf0 <yield>
80105823:	eb a4                	jmp    801057c9 <trap+0xc9>
80105825:	8d 76 00             	lea    0x0(%esi),%esi
    if(cpuid() == 0){
80105828:	e8 43 df ff ff       	call   80103770 <cpuid>
...
80105840:	e8 9b cd ff ff       	call   801025e0 <kbdintr>
    lapiceoi();
80105845:	e8 d6 ce ff ff       	call   80102720 <lapiceoi>
    break;
...
80105867:	e8 04 df ff ff       	call   80103770 <cpuid>
8010586c:	56                   	push   %esi
8010586d:	53                   	push   %ebx
8010586e:	50                   	push   %eax
8010586f:	68 44 76 10 80       	push   $0x80107644
80105874:	e8 e7 ad ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105879:	e8 a2 ce ff ff       	call   80102720 <lapiceoi>
    break;
...
8010591a:	e8 51 de ff ff       	call   80103770 <cpuid>
...
80105928:	68 68 76 10 80       	push   $0x80107668
8010592d:	e8 2e ad ff ff       	call   80100660 <cprintf>
      panic("trap");
80105932:	83 c4 14             	add    $0x14,%esp
80105935:	68 3e 76 10 80       	push   $0x8010763e
...
80105995:	e8 a6 cd ff ff       	call   80102740 <microdelay>
...
80105a2f:	bb 60 77 10 80       	mov    $0x80107760,%ebx
...
80105abb:	e8 20 ad ff ff       	call   801007e0 <consoleintr>
}
...
{
80106548:	89 d7                	mov    %edx,%edi
  pde = &pgdir[PDX(va)];
8010654a:	c1 eb 16             	shr    $0x16,%ebx
8010654d:	8d 34 98             	lea    (%eax,%ebx,4),%esi
{
80106550:	83 ec 0c             	sub    $0xc,%esp
  if(*pde & PTE_P){
80106553:	8b 06                	mov    (%esi),%eax
80106555:	a8 01                	test   $0x1,%al
80106557:	74 27                	je     80106580 <walkpgdir+0x40>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106559:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010655e:	8d 98 00 00 00 80    	lea    -0x80000000(%eax),%ebx
  ...
  return &pgtab[PTX(va)];
80106564:	c1 ef 0a             	shr    $0xa,%edi
}
80106567:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return &pgtab[PTX(va)];
8010656a:	89 fa                	mov    %edi,%edx
...
8010659a:	e8 91 de ff ff       	call   80104430 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
8010659f:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801065a5:	83 c4 10             	add    $0x10,%esp
801065a8:	83 c8 07             	or     $0x7,%eax
801065ab:	89 06                	mov    %eax,(%esi)
801065ad:	eb b5                	jmp    80106564 <walkpgdir+0x24>
801065af:	90                   	nop
}
...
8010663d:	68 68 77 10 80       	push   $0x80107768
...
801066e2:	68 06 71 10 80       	push   $0x80107106
...
801066f3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801066f6:	e8 75 d0 ff ff       	call   80103770 <cpuid>
...
8010683f:	e8 ac ce ff ff       	call   801036f0 <mycpu>
80106844:	89 c3                	mov    %eax,%ebx
80106846:	e8 a5 ce ff ff       	call   801036f0 <mycpu>
8010684b:	89 c7                	mov    %eax,%edi
8010684d:	e8 9e ce ff ff       	call   801036f0 <mycpu>
80106852:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106855:	83 c7 08             	add    $0x8,%edi
80106858:	e8 93 ce ff ff       	call   801036f0 <mycpu>
...
8010694f:	e8 dc da ff ff       	call   80104430 <memset>
...
80106980:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106981:	e9 5a db ff ff       	jmp    801044e0 <memmove>
    panic("inituvm: more than a page");
80106986:	83 ec 0c             	sub    $0xc,%esp
80106989:	68 ad 77 10 80       	push   $0x801077ad
...
80106a6e:	78 7b                	js     80106aeb <allocuvm+0x8b>
  if(newsz < oldsz)
80106a70:	3b 7d 0c             	cmp    0xc(%ebp),%edi
    return oldsz;
80106a73:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
80106a76:	72 75                	jb     80106aed <allocuvm+0x8d>
  a = PGROUNDUP(oldsz);
80106a78:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80106a7e:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
80106a84:	39 df                	cmp    %ebx,%edi
80106a86:	77 43                	ja     80106acb <allocuvm+0x6b>
80106a88:	eb 6e                	jmp    80106af8 <allocuvm+0x98>
...
80106a9b:	e8 90 d9 ff ff       	call   80104430 <memset>
...
80106ab5:	e8 06 fb ff ff       	call   801065c0 <mappages>
80106aba:	83 c4 10             	add    $0x10,%esp
80106abd:	85 c0                	test   %eax,%eax
80106abf:	78 47                	js     80106b08 <allocuvm+0xa8>
  for(; a < newsz; a += PGSIZE){
80106ac1:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106ac7:	39 df                	cmp    %ebx,%edi
80106ac9:	76 2d                	jbe    80106af8 <allocuvm+0x98>
    mem = kalloc();
80106acb:	e8 c0 b9 ff ff       	call   80102490 <kalloc>
    if(mem == 0){
80106ad0:	85 c0                	test   %eax,%eax
    mem = kalloc();
80106ad2:	89 c6                	mov    %eax,%esi
    if(mem == 0){
80106ad4:	75 ba                	jne    80106a90 <allocuvm+0x30>
      cprintf("allocuvm out of memory\n");
80106ad6:	83 ec 0c             	sub    $0xc,%esp
80106ad9:	68 e5 77 10 80       	push   $0x801077e5
80106ade:	e8 7d 9b ff ff       	call   80100660 <cprintf>
  if(newsz >= oldsz)
80106ae3:	83 c4 10             	add    $0x10,%esp
80106ae6:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106ae9:	77 4f                	ja     80106b3a <allocuvm+0xda>
      return 0;
...
80106b60:	5d                   	pop    %ebp
80106b61:	e9 ea fa ff ff       	jmp    80106650 <deallocuvm.part.0>
...
80106b99:	e8 b2 fa ff ff       	call   80106650 <deallocuvm.part.0>
...
80106be3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106be4:	e9 f7 b6 ff ff       	jmp    801022e0 <kfree>
    panic("freevm: no pgdir");
80106be9:	83 ec 0c             	sub    $0xc,%esp
80106bec:	68 19 78 10 80       	push   $0x80107819
...
80106c0e:	74 42                	je     80106c52 <setupkvm+0x52>
...
80106c20:	e8 0b d8 ff ff       	call   80104430 <memset>
...
80106c3b:	e8 80 f9 ff ff       	call   801065c0 <mappages>
...
80106c50:	72 d6                	jb     80106c28 <setupkvm+0x28>
}
...
80106c63:	56                   	push   %esi
      return 0;
80106c64:	31 f6                	xor    %esi,%esi
      freevm(pgdir);
80106c66:	e8 15 ff ff ff       	call   80106b80 <freevm>
      return 0;
80106c6b:	83 c4 10             	add    $0x10,%esp
}
80106c6e:	8d 65 f8             	lea    -0x8(%ebp),%esp
80106c71:	89 f0                	mov    %esi,%eax
80106c73:	5b                   	pop    %ebx
80106c74:	5e                   	pop    %esi
80106c75:	5d                   	pop    %ebp
80106c76:	c3                   	ret    
...
80106c8b:	a3 a4 54 11 80       	mov    %eax,0x801154a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106cae:	e8 8d f8 ff ff       	call   80106540 <walkpgdir>
  if(pte == 0)
...
80106cbf:	68 2a 78 10 80       	push   $0x8010782a
...
80106ce3:	0f 84 a0 00 00 00    	je     80106d89 <copyuvm+0xb9>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106ce9:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106cec:	85 c9                	test   %ecx,%ecx
80106cee:	0f 84 95 00 00 00    	je     80106d89 <copyuvm+0xb9>
80106cf4:	31 f6                	xor    %esi,%esi
80106cf6:	eb 4e                	jmp    80106d46 <copyuvm+0x76>
80106cf8:	90                   	nop
...
80106d13:	e8 c8 d7 ff ff       	call   801044e0 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80106d18:	58                   	pop    %eax
80106d19:	5a                   	pop    %edx
80106d1a:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106d1d:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106d20:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106d25:	53                   	push   %ebx
80106d26:	81 c2 00 00 00 80    	add    $0x80000000,%edx
80106d2c:	52                   	push   %edx
80106d2d:	89 f2                	mov    %esi,%edx
80106d2f:	e8 8c f8 ff ff       	call   801065c0 <mappages>
80106d34:	83 c4 10             	add    $0x10,%esp
80106d37:	85 c0                	test   %eax,%eax
80106d39:	78 39                	js     80106d74 <copyuvm+0xa4>
  for(i = 0; i < sz; i += PGSIZE){
80106d3b:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106d41:	39 75 0c             	cmp    %esi,0xc(%ebp)
80106d44:	76 43                	jbe    80106d89 <copyuvm+0xb9>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106d46:	8b 45 08             	mov    0x8(%ebp),%eax
80106d49:	31 c9                	xor    %ecx,%ecx
80106d4b:	89 f2                	mov    %esi,%edx
80106d4d:	e8 ee f7 ff ff       	call   80106540 <walkpgdir>
80106d52:	85 c0                	test   %eax,%eax
80106d54:	74 3e                	je     80106d94 <copyuvm+0xc4>
    if(!(*pte & PTE_P))
80106d56:	8b 18                	mov    (%eax),%ebx
80106d58:	f6 c3 01             	test   $0x1,%bl
80106d5b:	74 44                	je     80106da1 <copyuvm+0xd1>
    pa = PTE_ADDR(*pte);
80106d5d:	89 df                	mov    %ebx,%edi
    flags = PTE_FLAGS(*pte);
80106d5f:	81 e3 ff 0f 00 00    	and    $0xfff,%ebx
    pa = PTE_ADDR(*pte);
80106d65:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106d6b:	e8 20 b7 ff ff       	call   80102490 <kalloc>
80106d70:	85 c0                	test   %eax,%eax
80106d72:	75 8c                	jne    80106d00 <copyuvm+0x30>
      goto bad;
  }
  return d;
...
80106d77:	ff 75 e0             	pushl  -0x20(%ebp)
80106d7a:	e8 01 fe ff ff       	call   80106b80 <freevm>
  return 0;
80106d7f:	83 c4 10             	add    $0x10,%esp
80106d82:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
}
80106d89:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
80106d97:	68 34 78 10 80       	push   $0x80107834
80106d9c:	e8 cf 95 ff ff       	call   80100370 <panic>
      panic("copyuvm: page not present");
80106da1:	83 ec 0c             	sub    $0xc,%esp
80106da4:	68 4e 78 10 80       	push   $0x8010784e
80106da9:	e8 c2 95 ff ff       	call   80100370 <panic>
...
80106dbe:	e8 7d f7 ff ff       	call   80106540 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106dc5:	c9                   	leave  
  if((*pte & PTE_U) == 0)
80106dc6:	89 c2                	mov    %eax,%edx
  return (char*)P2V(PTE_ADDR(*pte));
80106dc8:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  if((*pte & PTE_U) == 0)
80106dcd:	83 e2 05             	and    $0x5,%edx
  return (char*)P2V(PTE_ADDR(*pte));
80106dd0:	05 00 00 00 80       	add    $0x80000000,%eax
80106dd5:	83 fa 05             	cmp    $0x5,%edx
80106dd8:	ba 00 00 00 00       	mov    $0x0,%edx
80106ddd:	0f 45 c2             	cmovne %edx,%eax
}
80106de0:	c3                   	ret    
80106de1:	eb 0d                	jmp    80106df0 <copyout>
80106de3:	90                   	nop
80106de4:	90                   	nop
80106de5:	90                   	nop
80106de6:	90                   	nop
...
80106e04:	75 40                	jne    80106e46 <copyout+0x56>
80106e06:	eb 70                	jmp    80106e78 <copyout+0x88>
80106e08:	90                   	nop
80106e09:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
80106e10:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106e13:	89 f1                	mov    %esi,%ecx
80106e15:	29 d1                	sub    %edx,%ecx
80106e17:	81 c1 00 10 00 00    	add    $0x1000,%ecx
80106e1d:	39 d9                	cmp    %ebx,%ecx
80106e1f:	0f 47 cb             	cmova  %ebx,%ecx
    if(n > len)
      n = len;
    memmove(pa0 + (va - va0), buf, n);
80106e22:	29 f2                	sub    %esi,%edx
80106e24:	83 ec 04             	sub    $0x4,%esp
80106e27:	01 d0                	add    %edx,%eax
80106e29:	51                   	push   %ecx
80106e2a:	57                   	push   %edi
80106e2b:	50                   	push   %eax
80106e2c:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
80106e2f:	e8 ac d6 ff ff       	call   801044e0 <memmove>
    len -= n;
    buf += n;
80106e34:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
  while(len > 0){
80106e37:	83 c4 10             	add    $0x10,%esp
    va = va0 + PGSIZE;
80106e3a:	8d 96 00 10 00 00    	lea    0x1000(%esi),%edx
    buf += n;
80106e40:	01 cf                	add    %ecx,%edi
  while(len > 0){
80106e42:	29 cb                	sub    %ecx,%ebx
80106e44:	74 32                	je     80106e78 <copyout+0x88>
    va0 = (uint)PGROUNDDOWN(va);
80106e46:	89 d6                	mov    %edx,%esi
    pa0 = uva2ka(pgdir, (char*)va0);
80106e48:	83 ec 08             	sub    $0x8,%esp
    va0 = (uint)PGROUNDDOWN(va);
80106e4b:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80106e4e:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    pa0 = uva2ka(pgdir, (char*)va0);
80106e54:	56                   	push   %esi
80106e55:	ff 75 08             	pushl  0x8(%ebp)
80106e58:	e8 53 ff ff ff       	call   80106db0 <uva2ka>
    if(pa0 == 0)
80106e5d:	83 c4 10             	add    $0x10,%esp
80106e60:	85 c0                	test   %eax,%eax
80106e62:	75 ac                	jne    80106e10 <copyout+0x20>
  }
  return 0;
}
