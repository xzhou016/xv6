...
main(void)
{
  ...
  12:	00 
  13:	c7 04 24 f6 07 00 00 	movl   $0x7f6,(%esp)
  ...
  32:	e8 83 03 00 00       	call   3ba <dup>
  dup(0);  // stderr
  37:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3e:	e8 77 03 00 00       	call   3ba <dup>
  43:	90                   	nop
  44:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

  for(;;){
    printf(1, "init: starting sh\n");
  48:	c7 44 24 04 fe 07 00 	movl   $0x7fe,0x4(%esp)
  4f:	00 
  ...
  7e:	74 c8                	je     48 <main+0x48>
      printf(1, "zombie!\n");
  80:	c7 44 24 04 3d 08 00 	movl   $0x83d,0x4(%esp)
  87:	00 
  ...
  for(;;){
    ...
    if(pid < 0){
      printf(1, "init: fork failed\n");
  96:	c7 44 24 04 11 08 00 	movl   $0x811,0x4(%esp)
  9d:	00 
  ...
  b1:	e8 8c 02 00 00       	call   342 <exit>
    ...
    if(pid == 0){
      exec("sh", argv);
  b6:	c7 44 24 04 c8 0a 00 	movl   $0xac8,0x4(%esp)
  bd:	00 
  be:	c7 04 24 24 08 00 00 	movl   $0x824,(%esp)
  c5:	e8 b0 02 00 00       	call   37a <exec>
      printf(1, "init: exec sh failed\n");
  ca:	c7 44 24 04 27 08 00 	movl   $0x827,0x4(%esp)
  d1:	00 
  d2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  d9:	e8 b2 03 00 00       	call   490 <printf>
      exit(0);
...
main(void)
{
  ...
  f9:	00 
  fa:	c7 04 24 f6 07 00 00 	movl   $0x7f6,(%esp)
 101:	e8 84 02 00 00       	call   38a <mknod>
    open("console", O_RDWR);
 106:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
 10d:	00 
 10e:	c7 04 24 f6 07 00 00 	movl   $0x7f6,(%esp)
 115:	e8 68 02 00 00       	call   382 <open>
...
free(void *ap)
{
 ...
 6c7:	89 10                	mov    %edx,(%eax)
  freep = p;
 6c9:	a3 d0 0a 00 00       	mov    %eax,0xad0
}
 6ce:	5b                   	pop    %ebx
 6cf:	5e                   	pop    %esi
 6d0:	5f                   	pop    %edi
 ...
 6ef:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 6f2:	a3 d0 0a 00 00       	mov    %eax,0xad0
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 1d d0 0a 00 00    	mov    0xad0,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 759:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 75b:	3b 15 d0 0a 00 00    	cmp    0xad0,%edx
...
morecore(uint nu)
{
 ...
 78d:	e8 ee fe ff ff       	call   680 <free>
  return freep;
 792:	8b 15 d0 0a 00 00    	mov    0xad0,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7b4:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 7b7:	89 15 d0 0a 00 00    	mov    %edx,0xad0
      return (void*)(p + 1);
 ...
 7cc:	eb e9                	jmp    7b7 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7ce:	c7 05 d0 0a 00 00 d4 	movl   $0xad4,0xad0
 7d5:	0a 00 00 
    base.s.size = 0;
 7d8:	ba d4 0a 00 00       	mov    $0xad4,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7dd:	c7 05 d4 0a 00 00 d4 	movl   $0xad4,0xad4
 7e4:	0a 00 00 
    base.s.size = 0;
 7e7:	c7 05 d8 0a 00 00 00 	movl   $0x0,0xad8
 7ee:	00 00 00 
